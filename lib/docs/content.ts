...
export const DOCS: DocPage[] = [
        {
                ...
                blocks: [
                        ...
                        {
                                type: 'h2',
                                fa: 'هوش مصنوعی مدیریت‌شده',
                                en: 'Managed AI, ready to use',
                        },
                        {
                                type: 'p',
                                fa: 'ویجنت حساب و اتصال هوش مصنوعی را روی سرور مدیریت می‌کند؛ بنابراین برای ساخت ایجنت نیازی به حساب سرویس‌دهنده یا کلید API ندارید. کافی است حالت سریع، متعادل یا حرفه‌ای را انتخاب کنید و استفاده و هزینهٔ پاسخ‌ها را در داشبورد ببینید.',
                                en: 'Vigent manages the AI account and connection on the server, so building an agent requires no provider account or API key. Choose Fast, Balanced or Premium mode and track reply usage and charges in your dashboard.',
                        },
                        {
                                type: 'h2',
                        ...
                        {
                                type: 'callout',
                                fa: 'برای شروع فقط با شماره موبایل وارد شوید؛ هوش مصنوعی از قبل آماده است.',
                                en: 'To get started, simply sign in with your phone number — the AI is already ready.',
                        },
                ],
        },
        {
                ...
                description: {
                        fa: 'ورود، ساخت فضای کاری و راه‌اندازی اولین ایجنت',
                        en: 'Sign in, create your workspace, and launch your first agent',
                },
                blocks: [
                        ...
                        { type: 'h2', fa: '۲. ساخت اولین ایجنت', en: '2. Build your first agent' },
                        {
                                type: 'p',
                                fa: 'از بخش ایجنت‌ها یک قالب متناسب با کسب‌وکارتان انتخاب کنید، نام و لحن را تنظیم کنید و محصولات، فایل‌ها یا سوالات پرتکرار را به دانش آن اضافه کنید. اتصال هوش مصنوعی از قبل توسط ویجنت فعال است.',
                                en: 'From Agents, choose a template for your business, set its name and tone, then add products, files or frequently asked questions to its knowledge. Vigent has already activated the AI connection.',
                        },
                        {
                                type: 'callout',
                                fa: 'دورهٔ آزمایشی با اعتبار اولیهٔ پاسخ فعال می‌شود؛ برای شروع نیازی به خرید اعتبار یا ساخت حساب دیگری ندارید.',
                                en: 'Your trial starts with reply credit, so there is nothing else to buy or set up before testing your agent.',
                        },
                        { type: 'h2', fa: '۳. چک‌لیست راه‌اندازی', en: '3. The activation checklist' },
                        {
                                type: 'p',
                                fa: 'پس از ورود، چک‌لیست راه‌اندازی شما را در چهار کار همراهی می‌کند: ساخت ایجنت، افزودن دانش یا محصول، اتصال یک کانال و تست پاسخ.',
                                en: 'After signing in, the activation checklist guides you through four tasks: create an agent, add knowledge or products, connect a channel, and test a reply.',
                        },
                ],
        },
        {
                ...
                description: {
                        fa: 'هوش مصنوعی آماده، حالت‌های پاسخ و نحوهٔ کسر اعتبار',
                        en: 'Ready-to-use AI, reply modes, and how credit is charged',
                },
                blocks: [
                        {
                                type: 'p',
                                fa: 'حساب هوش مصنوعی و مدل‌های زیربنایی روی سرور ویجنت مدیریت می‌شوند. شما نه حساب سرویس‌دهنده می‌سازید و نه کلیدی وارد می‌کنید؛ فقط ایجنت را تنظیم می‌کنید و حالت پاسخ مناسب را انتخاب می‌کنید.',
                                en: 'Vigent manages the AI account and underlying provider models on the server. You do not create a provider account or enter a key; simply configure your agent and choose the reply mode that fits the job.',
                        },
                        { type: 'h2', fa: 'اشتراک و اعتبار پاسخ دو نقش متفاوت دارند', en: 'Subscription and reply credit serve different roles' },
                        {
                                type: 'list',
                                items: [
                                        {
                        ...
                        { type: 'h2', fa: 'سه حالت ساده به‌جای نام‌های فنی', en: 'Three simple modes instead of technical model names' },
                        {
                                type: 'p',
                                fa: 'برای هر ایجنت یکی از حالت‌های سریع، متعادل یا حرفه‌ای را انتخاب می‌کنید. ویجنت مدل فنی پشت هر حالت را بر اساس کیفیت، سرعت و هزینه مدیریت و در صورت نیاز بدون تغییر تنظیمات ایجنت به‌روزرسانی می‌کند.',
                                en: 'Choose Fast, Balanced or Premium for each agent. Vigent manages the provider model behind each mode for quality, speed and cost, and can improve it without changing your agent settings.',
                        },
                        ...
                        {
                                type: 'callout',
                                fa: 'دورهٔ آزمایشی با اعتبار اولیهٔ پاسخ شروع می‌شود تا بتوانید ایجنت را بدون مرحلهٔ فنی اضافه بسازید و آزمایش کنید.',
                                en: 'The trial includes starter reply credit, so you can build and test an agent with no extra technical setup.',
                        },
                ],
        },
        {
                ...
                blocks: [
                        ...
                        { type: 'h2', fa: 'تنظیمات مدل', en: 'Model settings' },
                        {
                                ...
                                items: [
                                        {
                                                fa: 'حالت هوش مصنوعی: سریع، متعادل یا حرفه‌ای؛ اگر انتخاب نکنید حالت پیش‌فرض فضای کاری استفاده می‌شود',
        ...
        },
        {
                ...
                blocks: [
                        ...
                        {
                                type: 'p',
                                fa: 'وب‌هوک را یک‌بار در اپ تنظیم کنید. Callback URL: https://vigent.ir/api/webhook/instagram — Verify Token: مقدار META_APP_VERIFY_TOKEN که در env تنظیم کرده‌اید. فیلدهای subscribe: messages، messaging_postbacks، comments، mentions. منشن استوری از طریق messages و به‌شکل attachment با نوع story_mention دریافت می‌شود. در جریان Instagram Login، وقتی کاربر اکانت خود را وصل می‌کند، اکانت اینستاگرام او به‌صورت خودکار به این وب‌هوک subscribe می‌شود — هیچ فراخوانی subscribePageToApp لازم نیست (برخلاف جریان قدیمی فیسبوک).',
                                en: 'Configure the webhook once in the app. Callback URL: https://vigent.ir/api/webhook/instagram — Verify Token: the value of META_APP_VERIFY_TOKEN from your env. Subscribe to fields: messages, messaging_postbacks, comments, mentions. Story mentions arrive through messages as attachments with type story_mention. With the Instagram Login flow, when the user connects their account, their Instagram account is automatically subscribed to this webhook — no subscribePageToApp call is needed (unlike the old Facebook flow).',
                        },
                        {
                                type: 'h2',
...
POST https://graph.instagram.com/v21.0/me/messages`,
        ...
        },
        {
                ...
                blocks: [
                        {
                                type: 'p',
                                fa: 'با اتصال ووکامرس به ویجنت، کاتالوگ محصولات و سفارش‌های فروشگاه شما به‌صورت خودکار با ویجنت همگام می‌شود. ایجنت می‌تواند قیمت، موجودی و مشخصات محصولات را از داده‌های واقعی فروشگاه بخواند و وقتی سفارش جدید ثبت می‌شود، به‌صورت خودکار روی پروفایل مخاطب مربوطه ظاهر می‌گردد. راه‌اندازی این اتصال بسیار ساده شده است: کافی است آدرس سایت خود را وارد کنید تا ویجنت به‌صورت خودکار لینک و کلید امنیتی تولید کند.',
                                en: 'Connecting WooCommerce to Vigent keeps your store’s product catalog and orders in sync automatically. The agent can read live prices, stock, and product details, and every new order is attached to the matching contact profile. Setup is now simpler than ever: just enter your site URL and Vigent auto-generates the webhook link and secret for you.',
                        },
                        { type: 'h2', fa: 'دو حالت اتصال', en: 'Two connection modes' },
                        {
                                type: 'p',
                                fa: 'ویجنت از دو حالت اتصال پشتیبانی می‌کند. حالت «فقط webhook» (پیش‌فرض و ساده‌ترین حالت) که افزونه وردپرس داده‌ها را به‌صورت لحظه‌ای به ویجنت می‌فرستد و نیازی به کلید REST API ندارد. حالت «هم‌گام‌سازی کامل» که علاوه بر webhook، ویجنت هر ۳۰ دقیقه یک‌بار فروشگاه شما را هم کشش (poll) می‌کند تا تغییراتی که از webhook جا مانده‌اند را جبران کند — این حالت به Consumer Key/Secret ووکامرس نیاز دارد.',
                                en: 'Vigent supports two connection modes. “Webhook-only” (the default and simplest) where the WordPress plugin pushes data to Vigent in real time without needing REST API keys. “Full sync” mode where, in addition to webhooks, Vigent polls your store every 30 minutes to catch any changes that missed the webhook — this mode requires WooCommerce Consumer Key/Secret.',
                        },
                        ...
                        {
                                type: 'p',
                                fa: 'به وردپرس ۵.۸ به بالا و دسترسی مدیریت وردپرس برای نصب افزونه نیاز دارید. اگر ووکامرس نسخهٔ ۶ به بالا نصب باشد، محصولات و سفارش‌ها هم همگام می‌شوند؛ در غیر این صورت، فقط محتوای سایت همگام می‌شود. برای حالت «هم‌گام‌سازی کامل» به Consumer Key/Secret ووکامرس هم نیاز دارید (از WooCommerce → Settings → Advanced → REST API).',
                                en: 'You need WordPress 5.8+ and admin access to install the plugin. If WooCommerce 6+ is installed, products and orders sync too; otherwise only site content syncs. For “full sync” mode you also need WooCommerce Consumer Key/Secret (from WooCommerce → Settings → Advanced → REST API).',
                        },
                        { type: 'h2', fa: 'گام ۱ — ساخت اتصال در پنل ویجنت (تولید خودکار لینک و کلید)', en: 'Step 1 — Create the integration in Vigent (auto-generated link & key)' },
                        {
                                type: 'p',
                                fa: 'به صفحهٔ «محصولات» در داشبورد ویجنت بروید. در بالای صفحه، یک کارت اتصال ووکامرس می‌بینید. روی دکمهٔ «اتصال ووکامرس» بزنید، آدرس سایت خود را وارد کنید و «ایجاد اتصال» را بزنید. ویجنت به‌صورت خودکار یک آدرس webhook و یک کلید امنیتی تصادفی تولید می‌کند و هر دو را با دکمهٔ کپی به شما نمایش می‌دهد.',
                                en: 'Go to the “Products” page in the Vigent dashboard. At the top you’ll see a WooCommerce connection card. Click “Connect WooCommerce”, enter your site URL, and click “Create integration”. Vigent auto-generates a webhook URL and a random secret, and shows both with copy buttons.',
                        },
                        {
                                type: 'callout',
                                fa: 'نکتهٔ مهم: نیازی به وارد کردن Consumer Key/Secret در این مرحله نیست. این کلیدها فقط در صورتی لازم‌اند که بخواهید ویجنت هر ۳۰ دقیقه فروشگاه را poll کند. برای راه‌اندازی اولیه و دریافت لحظه‌ای داده‌ها، حالت webhook-only کافی است.',
                                en: 'Important: you don’t need to enter Consumer Key/Secret at this stage. Those keys are only needed if you want Vigent to poll your store every 30 minutes. For initial setup and real-time data, webhook-only mode is enough.',
                        },
                        { type: 'h2', fa: 'گام ۲ — نصب افزونهٔ وردپرس', en: 'Step 2 — Install the WordPress plugin' },
                        {
                                ...
                                items: [
                                        {
                                                fa: 'فایل افزونه را از پنل ویجنت (صفحهٔ محصولات یا اتصالات) یا از آدرس /downloads/vigent-wordpress.zip دانلود کنید.',
                                                en: 'Download the plugin zip from the Vigent panel (Products or Integrations page) or from /downloads/vigent-wordpress.zip.',
                                        },
                                        {
                                        ...
                                        {
                                                fa: 'افزونه را فعال کنید. یک منوی اصلی با نام «ویجنت» در نوار کناری مدیریت ظاهر می‌شود (نه زیر منوی ووکامرس).',
                                                en: 'Activate the plugin. A new top-level “Vigent” menu appears in the WordPress admin sidebar (not under WooCommerce).',
                                        },
                                        {
                                                fa: 'به «ویجنت ← تنظیمات» بروید و آدرس webhook و کلید امنیتی که از پنل ویجنت کپی کردید را در فیلدها قرار دهید.',
                                                en: 'Go to “Vigent → Settings” and paste the webhook URL and webhook secret you copied from the Vigent panel.',
                                        },
                                        {
                                                fa: 'روی «ذخیره تنظیمات» و سپس «تست اتصال» بزنید. افزونه یک پیام نمونه به ویجنت می‌فرستد تا اتصال را تأیید کند.',
                                                en: 'Hit “Save settings” then “Test connection”. The plugin sends a sample ping to Vigent to confirm the link works.',
                                        },
                                ],
                        },
                        ...
                        {
                                type: 'p',
                                fa: 'پس از تست موفق، به تب «هم‌گام‌سازی» در افزونه بروید و روی «ارسال همهٔ محصولات» (و سپس سفارش‌ها و محتوا) بزنید تا همهٔ داده‌های فعلی یک‌بار به ویجنت ارسال شوند. این کار برای فروشگاه‌های بزرگ ممکن است چند دقیقه طول بکشد. پس از آن، هر تغییر محصول/سفارش به‌صورت فوری (push) از طریق webhook به ویجنت می‌رسد.',
                                en: 'After a successful test, go to the “Sync” tab in the plugin and click “Send all products” (then orders and content) to push all current data to Vigent once. For large stores this can take a few minutes. After that, every product/order change is pushed to Vigent instantly via the webhook.',
                        },
                        {
                                type: 'callout',
                                fa: 'نکته: اگر هاست شما outgoing webhooks را محدود کرده، مطمئن شوید آدرس vigent.ir در allow-list است. در غیر این صورت افزونه نمی‌تواند به ویجنت بفرستد و (در حالت کامل) فقط همگام‌سازی کششی کار می‌کند.',
                                en: 'Note: if your host restricts outgoing webhooks, make sure vigent.ir is on the allow-list. Otherwise the plugin cannot push to Vigent and (in full mode) only the pull sync will work.',
                        },
                        { type: 'h2', fa: 'گام ۴ — تأیید در پنل ویجنت', en: 'Step 4 — Verify in the Vigent panel' },
                        {
                                type: 'p',
                                fa: 'به صفحهٔ «محصولات» در پنل ویجنت برگردید. باید ببینید وضعیت اتصال به «متصل» تغییر کرده، چک‌لیست همگام‌سازی تکمیل می‌شود، و لیست محصولات به‌روز می‌شود. در صورت بروز خطا، پیام آن در همین کارت نمایش داده می‌شود. می‌توانید با دکمهٔ «بروزرسانی محصولات» یک هم‌گام‌سازی دستی هم اجرا کنید.',
                                en: 'Back on the “Products” page in the Vigent panel you should see the connection status change to “Connected”, the sync checklist fill in, and the product list update. If any errors occur, they appear in the same card. You can also run a manual sync with the “Refresh products” button.',
                        },
                        { type: 'h2', fa: 'گام ۵ (اختیاری) — فعال‌سازی هم‌گام‌سازی کامل', en: 'Step 5 (optional) — Enable full sync' },
                        {
                                type: 'p',
                                fa: 'اگر می‌خواهید ویجنت هر ۳۰ دقیقه فروشگاه را هم poll کند (به‌علاوهٔ webhook)، باید Consumer Key/Secret ووکامرس را در پنل ویجنت وارد کنید. برای ساخت این کلیدها: در وردپرس به WooCommerce ← Settings ← Advanced ← REST API بروید، روی «Add key» بزنید، دسترسی «Read/Write» انتخاب کنید و کلیدها را کپی کنید. سپس در پنل ویجنت (بخش اتصالات) این کلیدها را وارد کنید.',
                                en: 'If you want Vigent to also poll your store every 30 minutes (in addition to webhooks), enter your WooCommerce Consumer Key/Secret in the Vigent panel. To create these keys: in WordPress go to WooCommerce → Settings → Advanced → REST API, click “Add key”, choose “Read/Write” permission, and copy the keys. Then enter them in the Vigent panel (Integrations section).',
                        },
                        { type: 'h2', fa: 'عیب‌یابی', en: 'Troubleshooting' },
                        {
                                ...
                                items: [
                                        {
                                                fa: 'خطای Fatal: Call to undefined method ... Order::get_billing() — این خطا در نسخه‌های قدیمی افزونه رخ می‌داد. افزونه را به نسخهٔ ۲.۰.۰ یا بالاتر به‌روزرسانی کنید.',
                                                en: 'Fatal error: Call to undefined method ... Order::get_billing() — this happened in older plugin versions. Update to plugin version 2.0.0 or higher.',
                                        },
                                        {
                                                fa: 'خطای ۴۰۱ (woocommerce_rest_cannot_view) در پنل ویجنت؟ این خطا در حالت poll رخ می‌دهد و به‌دلیل اشتباه بودن یا ناقص بودن Consumer Key/Secret است. کلیدها را در ووکامرس دوباره بسازید و در پنل ویجنت بروزرسانی کنید، یا حالت webhook-only را انتخاب کنید که نیازی به این کلیدها ندارد.',
                                                en: '401 error (woocommerce_rest_cannot_view) in the Vigent panel? This happens in poll mode and is caused by wrong/missing Consumer Key/Secret. Recreate the keys in WooCommerce and update them in the Vigent panel, or switch to webhook-only mode which doesn’t need them.',
                                        },
                                        {
                                                fa: 'محصولات در ویجنت ظاهر نمی‌شوند؟ بررسی کنید افزونه فعال است، آدرس webhook و کلید صحیح است، و یک هم‌گام‌سازی کامل اجرا کرده‌اید. برای بررسی، یک «تست اتصال» در افزونه بزنید.',
                                                en: 'Products not showing in Vigent? Make sure the plugin is active, the webhook URL and secret are correct, and you’ve run a full sync. To check, hit “Test connection” in the plugin.',
                                        },
                                        {
        ...
        },
        {
                ...
                description: {
                        fa: 'سه حالت مدیریت‌شده برای سرعت، کیفیت و هزینه',
                        en: 'Three managed modes for speed, quality, and cost',
                },
                blocks: [
                        {
                                type: 'p',
                                fa: 'در ویجنت با شناسه‌ها و نام‌های فنی سروکار ندارید. برای هر ایجنت یکی از سه حالت سریع، متعادل یا حرفه‌ای را انتخاب می‌کنید و ویجنت مدل زیربنایی را روی سرور مدیریت می‌کند.',
                                en: 'Vigent keeps provider slugs and technical model names out of your workflow. Choose Fast, Balanced or Premium for each agent while Vigent manages the underlying model on the server.',
                        },
                        { type: 'h2', fa: 'کدام حالت را انتخاب کنم؟', en: 'Which mode should I choose?' },
                        {
                                type: 'list',
                                items: [
                                        {
                                                fa: 'سریع: انتخاب پیش‌فرض برای بیشتر گفتگوهای فروش و پشتیبانی؛ سریع‌ترین و کم‌هزینه‌ترین حالت.',
                                                en: 'Fast: the default for most sales and support conversations; the quickest and lowest-cost mode.',
                                        },
                                        {
                                                fa: 'متعادل: مناسب گفتگوهای چندزبانه، پیام‌های تصویری و پاسخ‌هایی که ساختار دقیق‌تری می‌خواهند.',
                                                en: 'Balanced: suited to multilingual conversations, image-aware messages, and replies that need more structure.',
                                        },
                                        {
                                                fa: 'حرفه‌ای: برای گفتگوهای حساس، مبهم یا چندمرحله‌ای که دقت بیشتر از هزینه اهمیت دارد.',
                                                en: 'Premium: for sensitive, ambiguous, or multi-step conversations where accuracy matters more than cost.',
                                        },
                                ],
                        },
                        { type: 'h2', fa: 'هزینهٔ پاسخ', en: 'Reply charges' },
                        {
                                type: 'p',
                                fa: 'هر حالت قیمت مشخصی برای یک پاسخ موفق دارد. مبلغ پیش از ارسال از اعتبار رزرو می‌شود و فقط اگر پاسخ با موفقیت تولید شود نهایی خواهد شد؛ در خطا یا لغو، اعتبار به موجودی برمی‌گردد.',
                                en: 'Each mode has a clear price per successful reply. The amount is reserved before generation and captured only when the reply succeeds; failures and cancellations return it to your balance.',
                        },
                        {
                                type: 'callout',
                                fa: 'نام مدل فنی ممکن است برای حفظ کیفیت، سرعت یا قیمت بهتر تغییر کند، اما حالت انتخابی و قیمت اعلام‌شدهٔ شما ثابت و قابل‌فهم می‌ماند.',
                                en: 'Vigent may rotate the technical provider model to improve quality, speed, or cost, while your selected mode and displayed customer price stay clear and stable.',
                        },
                ],
        },
        {
                ...
                description: {
                        fa: 'دورهٔ آزمایشی، اشتراک، اعتبار پاسخ و روش‌های پرداخت',
                        en: 'Trial, subscriptions, reply credit, and payment methods',
                },
                blocks: [
                        {
                                type: 'p',
                        ...
                        {
                                type: 'callout',
                                fa: 'نیازی به حساب یا کلید هوش مصنوعی جداگانه ندارید. اشتراک و اعتبار پاسخ هر دو در ویجنت مدیریت می‌شوند و ریز مصرف در صورتحساب قابل مشاهده است.',
                                en: 'You do not need a separate AI account or key. Vigent manages both the subscription and reply credit, with an itemized usage history in Billing.',
                        },
                ],
        },
        {
        ...
        },
        {
                ...
                blocks: [
                        ...
                        {
                                type: 'h2',
                                fa: 'هزینهٔ پاسخ‌ها چگونه محاسبه می‌شود؟',
                                en: 'How are reply charges calculated?',
                        },
                        {
                                type: 'p',
                        ...
                        {
                                type: 'p',
                                fa: 'هر فضای کاری کاملاً ایزوله است و داده‌های آن فقط برای خودش قابل دسترسی است. توکن‌ها و اطلاعات محرمانهٔ اتصال کانال‌ها و یکپارچه‌سازی‌ها به‌صورت رمزنگاری‌شده ذخیره می‌شوند.',
                                en: 'Each workspace is fully isolated and its data is accessible only within that workspace. Channel and integration tokens and secrets are stored encrypted.',
                        },
                ],
        },
]
