...
export interface WidgetSettings {
        ...
        leadCapture: boolean
        /**
         * Force the visitor to fill the lead form — hide the "skip" button so they
         * can't start chatting without leaving name+phone. Default false (skipping
         * allowed) so the AI can fall back to extracting name/phone from the chat.
         */
...
export function normalizeWidgetSettings(raw: unknown): WidgetSettings {
        ...
        return {
                ...
                leadCaptureRequired: c.leadCaptureRequired === true,
                leadCaptureMessage,
