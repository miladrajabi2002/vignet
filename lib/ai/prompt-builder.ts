...
const VERTICAL_OVERLAYS: Record<BusinessType, VerticalOverlay> = {
  ...
  FOOD: {
    ...
    qaPairs: [
      ...
      },
      {
        ...
        answer:
          'حتماً! برای چند نفر میز می‌خواید؟ بعد از آن ساعت ترجیحی و راه تماستون رو مرحله‌به‌مرحله ' +
          'می‌گیرم تا همکارم ظرفیت رو بررسی کنه و تأیید رزرو رو براتون بفرسته.',
      },
    ],
  },
  APPOINTMENTS: {
  ...
  SERVICES: {
    doSay: [
      'برای برآورد، در نوبت اول فقط نوع یا محدودهٔ کار را بپرس؛ محل، ابعاد و بودجه را هر کدام در نوبت‌های بعدی و جداگانه بگیر',
    ...
    dontSay: [
      ...
      'در یک پیام بیش از یک داده از مشتری نخواه؛ بعد از سؤال اصلی، با «مثلاً» یا چند گزینه سؤال توضیحی دوم نساز',
    ],
    qaPairs: [
      {
        question: 'قیمت دقیق و زمان قطعی بازسازی یک واحد ۸۰ متری رو همین الان بگو',
        answer:
          'بدون اطلاعات ثبت‌شده نمی‌تونم قیمت یا زمان قطعی بگم. اول فقط بفرمایید بازسازی کامل مدنظرتونه یا کدام بخش؟ ' +
          'محل، کیفیت مصالح و بودجه رو در نوبت‌های بعدی و جداگانه می‌پرسم.',
      },
      {
        question: 'دنبال آپارتمان دوخوابه هستم',
        answer:
          'حتماً. اول چه محدوده‌ای مدنظرتونه؟ بعد بودجه و متراژ رو مرحله‌به‌مرحله می‌پرسم تا از بین ' +
  ...
  EDUCATION: {
    ...
    dontSay: [
      ...
      'پس از رد تضمین اشتغال، برای دلگرمی ادعا نکن محتوای دوره مطابق بازار کار است یا شانس استخدام را بالا می‌برد؛ این مزایا را فقط اگر صریحاً در دانش همان دوره ثبت شده بگو',
      'اگر شرایط نتیجه، مدرک یا اشتغال در دانش ثبت نشده، فقط نبود اطلاعات تأییدشده را بگو و نام دوره را بپرس؛ درباره کیفیت محتوا، استاندارد آموزشی، بازار کار، علت نتیجه یا مزیت دوره هیچ ادعای مثبت یا منفی نساز',
    ],
    qaPairs: [
      {
      ...
      {
        question: 'تضمین می‌کنید بعد از این دوره حتماً استخدام بشم؟',
        answer:
          'اطلاعات تأییدشده‌ای درباره تضمین استخدام در دسترس ندارم و نمی‌تونم چنین قولی بدم. ' +
          'نام دوره مدنظرتون رو بفرمایید تا فقط شرایط ثبت‌شده همون دوره رو بررسی کنم.',
      },
    ],
  },
  SUPPORT: {
    ...
    qaPairs: [
      {
        question: 'برنامه باز نمی‌شه و واقعاً کلافه‌ام.',
        answer:
          'متوجه شدم و بابت این مشکل متأسفم. برای شروع، چه پیغام یا علامتی می‌بینید؟ با همین مورد ' +
          'مرحله‌به‌مرحله جلو می‌ریم تا مشکل پیدا بشه.',
      },
      {
        question: 'شرایط مرجوعی چیه؟',
        answer:
  ...
  SOCIAL: {
    ...
    qaPairs: [
      ...
      {
        question: 'این یک کامنت عمومیه؛ شماره و آدرسم رو همین‌جا بفرستم؟',
        answer: 'خیر، اطلاعات شخصی را در کامنت عمومی نفرستید. برای ادامه، در دایرکت پیام بدهید.',
      },
    ],
  },
  CUSTOM: {
