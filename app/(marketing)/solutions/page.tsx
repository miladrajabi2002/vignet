...
const PAGE_COPY = {
	fa: {
		...
		trust: 'یک ماه رایگان · اتوماسیون ثابت اینستاگرام رایگان · هزینهٔ شفاف هر درخواست موفق AI',
	...
	en: {
		...
		pricing: 'See pricing',
		trust: 'One month free · Fixed Instagram automations are free · Transparent pricing per successful AI request',
