...
const SOLUTION_META: Record<string, { icon: ComponentType<{ className?: string }>; channel: string; question: string; answer: string; source: string }> = {
        'unified-inbox': { icon: Inbox, channel: 'صندوق پیام یکپارچه', question: 'سلام، سفارش ۲۳۸۵ امروز ارسال می‌شود؟', answer: 'بله؛ سفارش ۲۳۸۵ پردازش شده و امروز تحویل پست می‌شود. کد رهگیری را بعد از ارسال همین‌جا می‌فرستم.', source: 'سفارش‌های همگام فروشگاه' },
...
const SOLUTION_META_EN: typeof SOLUTION_META = {
        'unified-inbox': { icon: Inbox, channel: 'Unified inbox', question: 'Hi, is order 2385 shipping today?', answer: 'Yes — order 2385 has been processed and is being handed to the carrier today. I will send the tracking code right here once it ships.', source: 'Synchronized store orders' },
