...
const PRICING_FAQ = [
	...
	},
	{
		...
		a: 'اینستاگرام (دایرکت، کامنت و استوری)، تلگرام، واتساپ، بله، روبیکا، ویجت چت وب‌سایت و لینک چت اختصاصی. فروشگاه‌های ووکامرس هم می‌توانند محصولات خود را مستقیم به ایجنت متصل کنند. همه گفتگوها در یک صندوق یکپارچه مدیریت می‌شوند.',
	},
	{
		...
		'@graph': [
			{
				...
				url: canonical,
				description:
					'ایجنت هوشمند فروش و پشتیبانی فارسی برای اینستاگرام، تلگرام، واتساپ، بله، روبیکا و وب‌سایت — با یک ماه شروع رایگان.',
