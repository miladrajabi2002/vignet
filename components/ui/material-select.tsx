	...
	return (
		<div className={cn('relative min-w-0', className)}>
			...
			<button
				...
				onKeyDown={onKeyDown}
				className={cn(
					'spatial-press flex min-h-11 w-full min-w-0 items-center gap-2 rounded-xl border border-black/[0.08] bg-white px-3 text-start shadow-[0_6px_18px_rgba(0,0,0,0.055)] transition-[border-color,box-shadow,background-color] duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/15 disabled:cursor-not-allowed disabled:opacity-45',
