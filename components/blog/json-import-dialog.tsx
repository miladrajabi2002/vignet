...
import { POSTER_COLORS, buildPosterPrompt, posterSummaryFrom, type PosterColor } from '@/lib/blog/poster-prompt'
...
// ── Poster color variants (3 fixed palettes) — shared via lib/blog/poster-prompt ──
...
export function JsonImportDialog({ open, onClose, onImport }: JsonImportDialogProps) {
  ...
  function buildPosterPrompts() {
    ...
    const summary = posterSummaryFrom(parsed.excerpt, parsed.content || '')
