                ...
                >
                        ...
                        <div className="flex items-start gap-3.5 sm:gap-4">
                                ...
                                <div className="min-w-0 flex-1">
                                        ...
                                        <p className="mt-1.5 line-clamp-2 text-[12px] leading-5 text-[#42504d] sm:mt-2 sm:line-clamp-none sm:leading-7">{pillar.description}</p>
                                </div>
                        </div>
...
export function CapabilitiesSection({ locale }: { locale: HomeLocale }) {
        ...
        return (
                <section id="solutions" className="marketing-story-section marketing-section-capabilities scroll-mt-24 overflow-hidden bg-white px-3 py-8 sm:px-5 sm:py-20 lg:px-8">
                        <div className={cn(styles.capabilityCanvas, 'relative mx-auto max-w-[1380px] overflow-hidden rounded-[2rem] border border-emerald-950/[0.06] px-4 py-6 sm:rounded-[2.75rem] sm:px-8 sm:py-20 lg:px-12 lg:py-24')}>
                                ...
                                <div className="relative mx-auto max-w-7xl">
                                        <header data-scroll-reveal="up" className="mx-auto max-w-4xl text-center">
                                                ...
                                                <h2 aria-label={copy.pillarsTitle} className="mx-auto mt-4 max-w-4xl text-balance text-[clamp(1.45rem,5.4vw,4.15rem)] font-semibold leading-[1.24] tracking-[-0.035em] text-[#0c1715] rtl:tracking-normal">
                                                        <span aria-hidden>{titleStart} </span>
                                                        <span aria-hidden className="text-emerald-600">{titleAccent}</span>
                                                </h2>
                                                <p className="mx-auto mt-3 max-w-3xl text-pretty text-[13px] leading-7 text-[#4d5b58] sm:text-[15px] sm:leading-8">{copy.pillarsSubtitle}</p>
                                        </header>

                                        <CapabilityMap locale={locale} />

                                        <div data-scroll-reveal="scale" className="mx-auto mt-6 hidden max-w-4xl sm:mt-14 sm:block">
                                                <div className="flex flex-col items-center justify-between gap-3 rounded-[1.35rem] border border-emerald-950/[0.07] bg-white/90 px-4 py-3 shadow-[0_16px_50px_rgba(15,80,60,0.08)] sm:flex-row sm:gap-4 sm:py-4 sm:px-6">
