		...
		<footer className="bg-[var(--bg-base)] px-3 pb-3 pt-10 sm:px-5 sm:pb-5 sm:pt-14">
			<div className="marketing-grid-dark relative mx-auto max-w-[1500px] overflow-hidden rounded-[2rem] bg-black text-white shadow-[0_30px_90px_rgba(0,0,0,0.18)]">
				<div className="relative mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-14">
					<div className="relative grid gap-8 overflow-hidden rounded-[1.6rem] border border-white/10 bg-white/[0.035] p-6 text-center sm:p-9 lg:grid-cols-[1fr_auto] lg:items-end lg:text-start">
					...
					<div className="flex flex-col items-center gap-4 border-t border-white/10 pt-6 text-center text-[10px] text-white/35 sm:flex-row sm:justify-between sm:text-start">
