...
export function Footer() {
	...
	return (
		<footer className="bg-[var(--bg-base)] px-3 pb-3 pt-10 sm:px-5 sm:pb-5 sm:pt-14">
			<div className="marketing-grid-dark relative mx-auto max-w-[1500px] overflow-hidden rounded-[2rem] bg-black text-white shadow-[0_30px_90px_rgba(0,0,0,0.18)]">
				<div className="relative mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-14">
					<div className="relative grid gap-8 overflow-hidden rounded-[1.6rem] border border-white/10 bg-white/[0.035] p-6 sm:p-9 lg:grid-cols-[1fr_auto] lg:items-end">
						...
						<Link href="/login?next=/onboarding" className="marketing-pressable relative inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-white px-6 text-sm font-medium text-black shadow-[0_12px_35px_rgba(255,255,255,0.12)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black">
