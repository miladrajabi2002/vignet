...
const COPY = {
	fa: {
		...
		prompt: 'برای فروشگاه پوشاکم یک مشاور فروش می‌خواهم؛ موجودی را بداند، محصول مقایسه کند و در اینستاگرام و سایت پاسخ بدهد.',
		...
		steps: [
			...
			{ label: 'کانال‌ها', value: 'اینستاگرام، تلگرام و وب' },
	...
	en: {
		...
		prompt: 'I need a sales advisor for my clothing store. It should know stock, compare products, and reply on Instagram and my website.',
		...
		steps: [
			...
			{ label: 'Channels', value: 'Instagram, Telegram and web' },
