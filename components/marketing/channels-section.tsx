...
function ChannelCard({ channel, locale, index }: { channel: ChannelDefinition; locale: Locale; index: number }) {
        ...
        return (
                <li data-scroll-reveal="up" style={{ '--reveal-order': index } as CSSProperties} className="relative z-10 flex h-[86px] min-w-0 flex-col items-center justify-center rounded-[18px] border border-white bg-white px-2 py-2.5 text-center shadow-[0_10px_28px_rgba(15,23,42,0.07),0_2px_6px_rgba(15,23,42,0.035)] ring-1 ring-black/[0.035] lg:h-auto lg:min-h-[104px] lg:rounded-[22px] lg:px-2.5 lg:py-3 lg:shadow-[0_14px_42px_rgba(15,23,42,0.075),0_2px_8px_rgba(15,23,42,0.04)]">
...
function ChannelFlow({ locale }: { locale: Locale }) {
        return (
                <div className="relative min-h-[640px] lg:min-h-[560px]">
                        ...
                        <ul className="relative grid grid-cols-2 gap-x-3 gap-y-3 lg:grid-cols-6 lg:gap-3 lg:gap-y-4">
...
export function ChannelsSection({ locale }: { locale: Locale }) {
        ...
        return (
                <section id="unified-system" dir={locale === 'fa' ? 'rtl' : 'ltr'} className="marketing-story-section marketing-section-channels relative scroll-mt-24 overflow-hidden bg-[#fbfbfd] py-9 sm:py-24 lg:py-28">
                        ...
                        <div className="relative mx-auto w-full max-w-[1200px] px-4 sm:px-6 lg:px-8">
                                ...
                                <div aria-label={copy.ariaLabel} className="relative mt-6 rounded-[24px] border border-white bg-white/55 p-2.5 shadow-[0_24px_72px_rgba(15,23,42,0.07)] ring-1 ring-black/[0.035] backdrop-blur-sm sm:mt-14 sm:rounded-[36px] sm:bg-white/45 sm:p-5 sm:shadow-[0_30px_100px_rgba(15,23,42,0.075)] lg:p-7">
                                        ...
                                        <div className="mb-2 flex items-center justify-center gap-2 px-2 text-center text-[9px] font-extrabold leading-5 text-neutral-500 sm:mb-4 sm:text-[10px] sm:text-neutral-400">
