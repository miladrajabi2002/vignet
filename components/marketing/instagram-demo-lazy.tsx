...
function DemoSkeleton() {
        return (
                <div className="grid min-h-[30rem] items-center justify-center gap-5 md:min-h-[45rem] md:grid-cols-[minmax(300px,370px)_minmax(170px,220px)] md:gap-6" aria-hidden>
                        <div className="marketing-demo-skeleton mx-auto aspect-[393/852] w-full max-w-[248px] rounded-[46px] border border-white/10 bg-white/[0.035] sm:max-w-[320px]" />
