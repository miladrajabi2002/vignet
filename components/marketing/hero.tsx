...
export function Hero({ dashboard }: { dashboard?: ReactNode }) {
        ...
        return (
                <section className="marketing-hero-spatial relative overflow-hidden pb-10 pt-[92px] sm:pb-20 sm:pt-32 lg:pt-36">
                        ...
                        <div className="marketing-hero-content relative mx-auto w-full max-w-[1540px] px-3 sm:px-6 lg:px-8">
                                <div className="mx-auto flex max-w-6xl flex-col items-center text-center">
                                        ...
                                        <h1 className="mt-7 w-full text-balance text-[clamp(2.15rem,10vw,4.1rem)] font-medium leading-[1.22] tracking-[-0.045em] text-[var(--text-primary)] rtl:tracking-normal sm:mt-8 sm:text-[clamp(3rem,7vw,6.4rem)] sm:leading-[1.15]">
                                        ...
                                        <p className="mx-auto mt-5 max-w-2xl text-pretty text-[14px] leading-7 text-[var(--text-secondary)] sm:mt-7 sm:text-lg sm:leading-9">
                                                {t('subtitle')}
                                        </p>

                                        <Link href="/login?next=/onboarding" className="marketing-pressable group mt-7 inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-black px-6 text-sm font-medium text-white shadow-[0_16px_38px_rgba(0,0,0,0.18)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 sm:mt-9 sm:min-h-[3.25rem] sm:px-7">
