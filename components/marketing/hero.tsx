        ...
        return (
                ...
                >
                        <div className="relative overflow-hidden rounded-[1.5rem] border border-black bg-[#050505] text-white shadow-[0_26px_70px_rgba(0,0,0,0.22)] sm:rounded-[2rem] sm:shadow-[0_34px_100px_rgba(0,0,0,0.27)]">
                                ...
                                <div className="relative hidden px-3.5 pt-3.5 sm:block sm:px-5">
...
export function Hero() {
        ...
        return (
                <section className="marketing-hero-spatial relative overflow-hidden pb-6 pt-[76px] sm:pb-16 sm:pt-28 lg:flex lg:min-h-[min(820px,100svh)] lg:items-center lg:pb-14 lg:pt-24">
                        <Spotlight />

                        <div className="marketing-hero-content relative mx-auto grid w-full max-w-7xl items-center gap-5 px-4 sm:gap-10 sm:px-8 lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)] lg:gap-8 xl:gap-12">
                                <div className="mx-auto max-w-xl text-center lg:mx-0 lg:max-w-none lg:text-start">
                                        ...
                                        <p
                                                className="mx-auto mt-3 max-w-lg text-[15px] leading-7 text-[var(--text-secondary)] sm:mt-5 sm:text-base sm:leading-8 lg:mx-0"
                                        >
                                                {t('subtitle')}
                                        </p>

                                        <div
                                                className="mt-4 grid grid-cols-[1.08fr_0.92fr] items-center justify-center gap-2.5 sm:mt-7 sm:flex sm:gap-3 lg:justify-start"
                                        >
                                                <Link
                                        ...
                                        <div
                                                className="mt-3 flex items-center justify-center sm:mt-5 sm:flex-wrap sm:gap-2 lg:justify-start"
                                        >
