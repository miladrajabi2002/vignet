...
export async function PricingSection() {
        ...
        return (
                        ...
                        <div className="mx-auto max-w-7xl px-5 sm:px-8">
                                ...
                                <div className="mt-6 space-y-3 md:hidden">
                                        {mobilePlans.map((view, index) => (
                                                ...
                                                >
                                                        ...
                                                        <div className="border-t border-[var(--border-subtle)] px-4 pb-4 pt-3 sm:px-5 sm:pb-5 sm:pt-4"><MobilePlanDetails view={view} /></div>
                                                </details>
                                        ))}
                                </div>
                                ...
                                <p className="mx-auto mt-6 max-w-2xl text-center text-xs leading-6 text-[var(--text-muted)] sm:mt-8">{t('billingNote')}</p>
                        </div>
                </section>
        )
}
...
function MobilePlanDetails({ view }: { view: MobilePlanView }) {
        return (
                <>
                        <ul className="space-y-2.5 text-xs leading-5 text-[var(--text-secondary)] sm:space-y-3">
