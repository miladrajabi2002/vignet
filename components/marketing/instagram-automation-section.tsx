...
export function InstagramAutomationSection({ locale }: { locale: HomeLocale }) {
        ...
        return (
                <section id="instagram-automation" className="marketing-story-section marketing-section-instagram relative scroll-mt-24 overflow-hidden bg-[#070707] px-5 py-9 text-white sm:px-8 sm:py-24 lg:py-28">
                        ...
                        <div className="relative mx-auto grid max-w-6xl items-center gap-6 sm:gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:gap-14">
                                <div className="lg:sticky lg:top-28 lg:self-start">
                                        ...
                                        />
                                        <ul className="mt-5 grid gap-2 text-[13px] leading-6 text-white/70 sm:mt-7 sm:gap-2.5 sm:grid-cols-2 lg:grid-cols-1">
                                                {bullets.map((item, index) => (
                                                        <li key={item} data-scroll-reveal="side" style={{ '--reveal-order': index } as React.CSSProperties} className="flex min-h-10 items-center gap-3 rounded-2xl border border-white/[0.07] bg-white/[0.035] px-3 py-2 sm:min-h-12 sm:px-3.5 sm:py-2.5">
