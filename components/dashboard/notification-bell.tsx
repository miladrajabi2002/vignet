                                        ...
                                        <AnimatePresence>
                                                {toast && (
                                                        <motion.aside
                                                                ...
                                                                className="fixed end-3 top-[4.9rem] z-[101] w-[min(24rem,calc(100vw-1.5rem))] overflow-hidden rounded-[1.4rem] border border-black/10 bg-white/95 p-2 shadow-[0_22px_70px_rgba(0,0,0,0.22)] backdrop-blur-xl sm:end-5 sm:top-[5.75rem] sm:w-[26rem] sm:rounded-2xl sm:bg-white sm:p-3 xl:top-[6.75rem]"
                                                        >
                                                                ...
                                                                <span className="absolute inset-x-0 bottom-0 h-[3px] bg-black/[0.06]" aria-hidden="true">
                                                                        <span
                                                                                className="block h-full bg-black motion-reduce:!animate-none"
                                                                                style={{
