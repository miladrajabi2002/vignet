...
export function WidgetPreview({
	...
	return (
		<div
			dir={isRtl ? 'rtl' : 'ltr'}
			className="relative h-[500px] overflow-hidden rounded-2xl border border-[var(--border-default)] bg-[var(--bg-base)]"
			style={{
		...
		>
			{/* view switch */}
			<div className="absolute start-3 top-3 z-10 inline-flex rounded-lg border border-[var(--border-default)] bg-[var(--bg-surface)] p-0.5 text-[11px]">
				{(
					[
