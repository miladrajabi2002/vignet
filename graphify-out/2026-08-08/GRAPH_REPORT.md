...
## Corpus Check
- 718 files · ~538,282 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4253 nodes · 9952 edges · 268 communities (243 shown, 25 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 102 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d31ac94`
...
## Communities (268 total, 25 thin omitted)
...
### Community 1 - "cn"
Cohesion: 0.09
Nodes (23): agent_hint_body(), agent_hint_title(), AgentsPage(), PLAN_KEY, DigitalMenuDashboardPage(), isOrderStatus(), ORDER_STATUSES, OrdersPage() (+15 more)

### Community 2 - "ui.tsx"
Cohesion: 0.11
Nodes (23): AgentSettingsPage(), BUSINESSES, NewAgentPage(), assurances, metadata, PLAN_FA_NAMES, PRICING_FAQ, PricingPage() (+15 more)
...
Cohesion: 0.10
Nodes (25): AgentCatalogPage(), EditAutomationPage(), NewAutomationPage(), AgentKnowledgePage(), NewInstagramAutomationPage(), InstagramWorkspacePage(), CHANNELS, IntegrationsPage() (+17 more)
...
Cohesion: 0.16
Nodes (17): InstagramAutomationContent(), normalizeSettings(), EditInstagramAutomationPage(), ChannelSettingsCard(), InstagramAutomationManager(), TABS, Automation, AutomationAction (+9 more)
...
Cohesion: 0.07
Nodes (47): BillingPage(), ContactDetailPage(), ConversationThreadPage(), ConversationsPage(), VALID_CHANNELS, VALID_SALES_FILTERS, VALID_STATUSES, AttentionItem() (+39 more)

### Community 15 - "syncOnboarding"
Cohesion: 0.09
Nodes (18): FacebookPagesResult, IgHost, IgWebhook, instagramAdapter(), InstagramPageOption, IMPORTANT: do NOT skip messages based on folder flags., ResolvedHost, BotApiError (+10 more)

### Community 16 - "session.ts"
Cohesion: 0.15
Nodes (24): refreshLongLivedToken(), NotifyParams, notifyWorkspace(), sendOperatorTelegramNotification(), dispatchSummary(), refreshLongLivedToken(), alertSilentChannels(), cleanupOldRecords() (+16 more)
...
Cohesion: 0.17
Nodes (17): onRequestError(), register(), captureError(), captureLog(), captureWarning(), emitConsole(), errorDetails(), ErrorLevel (+9 more)

### Community 19 - "registry.ts"
Cohesion: 0.16
Nodes (22): ModelSelect(), TIER_ICON, ReplyCreditEstimator(), getOpenRouterConfigStatus(), AGENT_MODELS, AgentModel, BY_ALIAS, findModel() (+14 more)
...
Cohesion: 0.09
Nodes (37): entryOwnerIds(), getContactName(), handleInbound(), handleInstagramGlobalInbound(), IgWebhookEntry, markAssistantDelivery(), persistFixedAssistantReply(), persistInboundOnly() (+29 more)
...
Cohesion: 0.13
Nodes (24): AdminCreditTopupPatternData, AdminSubscriptionPatternData, formatPersianDate(), generateCode(), IppanelMeta, ippanelSend(), isSmsConfigured(), OtpAuditContext (+16 more)
...
Cohesion: 0.06
Nodes (68): batchSchema, digest(), eventSchema, handleManualSync(), loadManualIntegration(), normalizeSiteUrl(), parseDelivery(), pluginVersionFromHeaders() (+60 more)

### Community 28 - "config.ts"
Cohesion: 0.06
Nodes (55): bodySchema, GET(), Params, POST(), bodySchema, GET(), OPTIONS(), Params (+47 more)
...
Cohesion: 0.11
Nodes (24): fmtDay(), AdminUsersPage(), BadgeTone, PLAN_LABEL, PLAN_OPTIONS, PlanFilter, startOfToday(), VALID_PLANS (+16 more)
...
Cohesion: 0.12
Nodes (21): Params, PATCH(), settingsSchema, Params, POST(), buildMessengerConfig(), MessengerConfig, MessengerSettings (+13 more)

### Community 37 - "page.tsx"
Cohesion: 0.17
Nodes (23): generateMetadata(), Props, PublicBlogPostPage(), AdminBlogManager(), AdminPostRow, STATUS_BADGE_CLS, STATUS_LABELS_EN, STATUS_LABELS_FA (+15 more)
...
Cohesion: 0.11
Nodes (29): POST(), analyzeSalesConversation(), backfillWorkspaceSalesInsights(), clamp(), countConsecutiveUnanswered(), detectRepeatedRequest(), excerpt(), firstMatch() (+21 more)
...
Cohesion: 0.08
Nodes (31): AnalyticsPage(), daysAgo(), nfFa(), ContactsPage(), STAGE_LABELS_EN, STAGE_LABELS_FA, CHANNEL_LABELS_FA, SalesFilter (+23 more)

### Community 42 - "route.ts"
Cohesion: 0.11
Nodes (38): DELETE(), allClaimedInstagramIds(), GET(), Params, POST(), PUT(), appUrl(), GET() (+30 more)

### Community 43 - "jobs.ts"
Cohesion: 0.13
Nodes (21): confirmSchema, Params, POST(), POST(), secretsMatch(), CampaignJobData, SummaryJobData, IngestionJobData (+13 more)

### Community 44 - "chat-client.tsx"
Cohesion: 0.06
Nodes (35): bodySchema, Params, POST(), GET(), ownAgent(), Params, POST(), saveSchema (+27 more)
...
Cohesion: 0.23
Nodes (9): GET(), DELETE(), GET(), isAdminAuthedRequest(), parseHttpUrl(), resolvePrismaStudioUrl(), readBotToken(), resolveInstagramHost() (+1 more)
...
Cohesion: 0.12
Nodes (15): BusyAction, Feedback, fetchOperatorHealth(), GlassButton(), localeDate(), localeNumber(), OperatorChannelHealth, OperatorChannelInfo (+7 more)

### Community 51 - "page.tsx"
Cohesion: 0.14
Nodes (22): baseUrl(), bodySchema, Params, POST(), WEBHOOK_PATH, baleAdapter(), getBaleBotInfo(), setBaleWebhook() (+14 more)
...
Cohesion: 0.15
Nodes (26): AdminVigentoPage(), CAPABILITIES, bodySchema, Params, POST(), POST(), recordRun(), requestSchema (+18 more)

### Community 57 - "vertical-bookings-vigento.test.ts"
Cohesion: 0.09
Nodes (22): BrandHeader(), AdminLayout(), metadata, MobileNavTrigger(), adminLogout(), metadata, MarketingLayout(), SESSION_COOKIE_NAMES (+14 more)
...
Cohesion: 0.06
Nodes (69): GET(), PATCH(), Props, bookingErrorResponse(), GET(), POST(), GET(), POST() (+61 more)

### Community 62 - "helpers.ts"
Cohesion: 0.17
Nodes (19): AdminPaymentsPage(), AdminPaymentDetailPage(), StatusSummary(), AdminRevenuePage(), PLAN_BADGE, fmtIRR(), fmtUSD(), calculateFinanceSummary() (+11 more)
...
Cohesion: 0.09
Nodes (26): GET(), PUT(), schema, GET(), BodySchema, POST(), GET(), POST() (+18 more)

### Community 67 - "chat-orchestrator.ts"
Cohesion: 0.18
Nodes (16): bodySchema, Params, POST(), campaignDeliveryText(), processCampaign(), processRecipient(), SEND_INTERVAL_MS, waitForRateLimit() (+8 more)
...
Cohesion: 0.24
Nodes (3): Props, PublicPost, PublicPostCard()
...
Cohesion: 0.13
Nodes (32): AdminOverviewPage(), parseRange(), startOfToday(), ClearErrorLogsButton(), SystemErrorsPanel(), getAiOverview(), AgentSpark, conversationsDaily() (+24 more)
...
Cohesion: 0.15
Nodes (19): doSignOut(), GET(), POST(), POST(), POST(), POST(), { handlers, auth, signOut }, isPlatformOwnerPhone() (+11 more)

### Community 77 - "conversation-thread.tsx"
Cohesion: 0.20
Nodes (17): ALLOWED, EXTENSION, POST(), GET(), ownAgent(), Params, POST(), buffer (+9 more)
...
Cohesion: 0.24
Nodes (7): formatWooSyncResult(), SyncFeedback, WooSyncResult, entityLabel(), IntegrationCard(), StoreIntegrationsSection(), SyncLogEntry

### Community 80 - "scheduler.ts"
Cohesion: 0.16
Nodes (13): ConversationPanel(), HandoffAlertProp, MESSENGER_META, getPopularPosts(), loadPopularPosts, PopularCard(), PopularPosts(), PostPreview (+5 more)
...
Cohesion: 0.20
Nodes (18): databaseHealth(), FailedJobLog, GET(), HealthState, POST(), QueueRow, redisAndQueuesHealth(), safeJobData() (+10 more)
...
Cohesion: 0.12
Nodes (18): AgentLayout(), AgentDetailPage(), AgentGrowthPanel(), AgentSetupPanel(), CHANNEL_META, ConnectionSummary, GrowthAction, safeHostname() (+10 more)
...
Cohesion: 0.14
Nodes (11): CHANNEL_LABEL, STATUS_META, GATEWAY_BADGE, PLAN_BADGE, STATUS_BADGE, AdminPagination(), FilterPills(), TableShell() (+3 more)
...
Cohesion: 0.21
Nodes (10): GET(), META, StatusPage(), HealthCheck, HealthReport, runHealthChecks(), timed(), withTimeout() (+2 more)
...
Cohesion: 0.21
Nodes (13): ChatAgent, StartChatParams, ASSISTANT_OFFER_RE, explicitRequestedCount(), extractProductTerms(), fetchCatalogProducts(), historyForProductTurn(), normalizePersianText() (+5 more)
...
Cohesion: 0.16
Nodes (18): DELETE(), Params, GET(), PATCH(), DashboardLayout(), metadata, metadata, OnboardingPage() (+10 more)
...
Cohesion: 0.14
Nodes (17): bodySchema, faqText(), normalize(), Params, POST(), redispatchExisting(), AgentLearningPage(), LearningCenter() (+9 more)
...
Cohesion: 0.14
Nodes (18): VigentoComposer(), AgentSettingsForm(), getRoleTemplate(), getRoleTemplatesForBusiness(), getSuggestedRoleTemplate(), LEGACY_ROLE_TEMPLATES, makeRecommendedBusinessRole(), normalizeBusinessType() (+10 more)
...
Cohesion: 0.12
Nodes (28): CHANNEL_LABELS, FailedJobLog, HealthPayload, HealthState, QUEUE_LABELS, Service, ServiceHealthPanel(), STATE_META (+20 more)
...
Cohesion: 0.11
Nodes (27): AdminAgentDetailPage(), CHANNEL_LABEL, AdminAgentsPage(), AdminBlogPage(), AdminConversationDetailPage(), CHANNEL_LABEL, STATUS_LABEL, AdminConversationsPage() (+19 more)
...
Cohesion: 0.26
Nodes (10): DELETE(), GET(), CapturedPayload, categorizePayload(), clearWebhookPayloads(), getWebhookPayloads(), logWebhookPayload(), payloadOwnerIds() (+2 more)
...
Cohesion: 0.11
Nodes (31): DELETE(), GET(), ownAgent(), Params, PUT(), putSchema, GET(), Params (+23 more)
...
Cohesion: 0.05
Nodes (54): setLocale(), NAV_ITEMS, NavItem, NavList(), RangeTabs(), COPY, fmtBytes(), Metrics (+46 more)

### Community 235 - "route.ts"
Cohesion: 0.31
Nodes (7): DELETE(), ownContact(), Params, PATCH(), updateSchema, mocks, params

### Community 237 - "pdf-parse"
Cohesion: 0.27
Nodes (10): bodySchema, Params, POST(), createHandoffAlert(), escapeTelegramHtml(), formatOperatorAlertMessage(), getConnectedMessengerChannels(), HandoffContext (+2 more)
...
Cohesion: 0.29
Nodes (7): splitOutboundText(), getWhatsappInfo(), parseWhatsappToken(), WaCreds, WaWebhook, whatsappAdapter(), parseQrToken()

### Community 243 - "neural-network-primitives.tsx"
Cohesion: 0.10
Nodes (18): COLOR_PRESETS, LinkState, ChatComposer, ChatComposerProps, COMPOSER_GEOMETRY, SendButton(), DeliveryFeedback, OperatorReply() (+10 more)
...
Cohesion: 0.25
Nodes (7): POST(), MODEL_ALIASES, agentCreateSchema, promptConversationSchema, promptFormatSchema, promptQAPairSchema, roleTemplateKeys
...
Cohesion: 0.07
Nodes (30): BusinessProfileStep(), ICONS, Props, SubStep, CapabilityOptions(), Locale, OPTION_META, optionLabel() (+22 more)
...
- **Why does `cn()` connect `react-dom` to `cn`, `ui.tsx`, `page-header.tsx`, `prisma.ts`, `page.tsx`, `woo-connect-wizard.tsx`, `registry.ts`, `commercial-config.ts`, `rateLimit`, `route.ts`, `layout.tsx`, `page.tsx`, `trend-chart.tsx`, `route.ts`, `route.ts`, `social-links.tsx`, `iphone-preview.tsx`, `page.tsx`, `page.tsx`, `customer-identification.ts`, `route.ts`, `automation-manager.tsx`, `scheduler.ts`, `page.tsx`, `validation.ts`, `logo.tsx`, `service.ts`, `route.ts`, `neural-network-primitives.tsx`, `page.tsx`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `getCurrentUser()` connect `chat-client.tsx` to `tts.ts`, `route.ts`, `route.ts`, `qr-config.ts`, `campaign-composer.tsx`, `chat-engine.ts`, `prisma.ts`, `models.ts`, `route.ts`, `commercial-config.ts`, `woocommerce.ts`, `oauth.ts`, `route.ts`, `route.ts`, `jobs.ts`, `getVerticalPack`, `route.ts`, `layout.tsx`, `page.tsx`, `low-credit-alert.ts`, `types.ts`, `chat-orchestrator.ts`, `PageHeader`, `conversation-thread.tsx`, `wp-content.ts`, `route.ts`, `pdf-parse`, `media-uploader.tsx`, `route.ts`, `route.ts`, `route.ts`, `normalizeChatLinkSettings`, `route.ts`, `readBotToken`, `route.ts`, `admin-broadcast-form.tsx`, `route.ts`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `buffer` connect `conversation-thread.tsx` to `automation.ts`, `tts.ts`, `embeddings.ts`, `chat-engine.ts`, `qr-config.ts`, `commercial-config.ts`, `woocommerce.ts`, `config.ts`, `registry.ts`, `oauth.ts`, `route.ts`, `jobs.ts`, `getVerticalPack`, `route.ts`, `contacts-view.tsx`, `sitemap.ts`, `layout.tsx`, `material-select.tsx`, `route.ts`?**
