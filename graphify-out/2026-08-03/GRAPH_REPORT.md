...
## Corpus Check
- 719 files · ~540,783 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4274 nodes · 10012 edges · 268 communities (240 shown, 28 thin omitted)
...
## Communities (268 total, 28 thin omitted)
...
### Community 1 - "cn"
Cohesion: 0.13
Nodes (26): bodySchema, GET(), Params, POST(), bodySchema, POST(), GET(), normalizeSiteUrl() (+18 more)

### Community 2 - "ui.tsx"
Cohesion: 0.12
Nodes (22): Params, PATCH(), settingsSchema, Params, POST(), MessengerConfig, MessengerSettings, newWebhookToken() (+14 more)
...
Cohesion: 0.07
Nodes (33): AgentCatalogPage(), NewAutomationPage(), AgentKnowledgePage(), AgentLayout(), AgentSettingsPage(), BUSINESSES, NewAgentPage(), NewInstagramAutomationPage() (+25 more)
...
Cohesion: 0.24
Nodes (16): AvailabilityRuleLike, AvailabilityWindow, AvailableSlot, buildAvailableSlots(), BusyAppointmentLike, DateExceptionLike, effectiveAvailabilityWindows(), inspectRequestedSlot() (+8 more)
...
Cohesion: 0.16
Nodes (17): EditAutomationPage(), InstagramAutomationContent(), normalizeSettings(), EditInstagramAutomationPage(), InstagramAutomationManager(), TABS, Automation, AutomationAction (+9 more)

### Community 9 - "prompt-builder.ts"
Cohesion: 0.08
Nodes (37): NaturalConversationControls(), AgentSettingsForm(), EMPTY_CONFIG, LayerTab, BaseRoleKey, booleanOrDefault(), buildLayeredPrompt(), BUSINESS_ROLE_SPECS (+29 more)
...
Cohesion: 0.15
Nodes (17): AdminAgentsPage(), AdminBlogPage(), AdminPagination(), BADGE_TONES, BadgeTone, Card(), EmptyState(), LevelBadge() (+9 more)

### Community 12 - "captureError"
Cohesion: 0.08
Nodes (49): appendSalesGuidance(), buildDeterministicTurnReply(), buildSystemPrompt(), bumpProductQueries(), generateReply(), GenerateReplyOptions, GenerateReplyResult, hydrateSystemPrompt() (+41 more)
...
Cohesion: 0.14
Nodes (22): ContactsPage(), AttentionItem(), buildTrend(), daysAgo(), isRecord(), MODULE_META, OverviewPage(), percentDelta() (+14 more)
...
Cohesion: 0.08
Nodes (37): assurances, metadata, PLAN_FA_NAMES, PRICING_FAQ, PricingPage(), Meter(), ModelSelect(), TIER_ICON (+29 more)
...
Cohesion: 0.07
Nodes (38): entryOwnerIds(), getContactName(), handleInbound(), handleInstagramGlobalInbound(), IgWebhookEntry, markAssistantDelivery(), persistFixedAssistantReply(), persistInboundOnly() (+30 more)
...
Cohesion: 0.07
Nodes (54): sendPurchaseConfirmation(), captureError(), captureWarning(), refreshLongLivedToken(), crawlUrlToKnowledge(), refreshStaleUrlKnowledge(), NotifyParams, notifyWorkspace() (+46 more)
...
Cohesion: 0.06
Nodes (70): batchSchema, digest(), eventSchema, handleManualSync(), loadManualIntegration(), normalizeSiteUrl(), parseDelivery(), pluginVersionFromHeaders() (+62 more)

### Community 28 - "config.ts"
Cohesion: 0.05
Nodes (50): GET(), Avatar(), ChatLinkClient(), errorText(), Intro(), isRetryableError(), Msg, nextId() (+42 more)
...
Cohesion: 0.09
Nodes (33): AdminPaymentsPage(), AdminPaymentDetailPage(), GATEWAY_BADGE, PLAN_BADGE, STATUS_BADGE, StatusSummary(), AdminRevenuePage(), PLAN_BADGE (+25 more)
...
Cohesion: 0.11
Nodes (28): appUrl(), GET(), handleCallback(), POST(), readPid(), BillingPage(), AdminCommercialEvent, enqueueAdminCommercialSms() (+20 more)
...
Cohesion: 0.10
Nodes (21): AnalyticsPage(), daysAgo(), nfFa(), STAGE_LABELS_EN, STAGE_LABELS_FA, ContactRow, ContactsView(), BarItem (+13 more)

### Community 42 - "route.ts"
Cohesion: 0.12
Nodes (35): DELETE(), allClaimedInstagramIds(), GET(), Params, POST(), PUT(), appUrl(), GET() (+27 more)

### Community 43 - "jobs.ts"
Cohesion: 0.19
Nodes (22): BodySchema, POST(), createQueueConnection(), isQueueDisabled(), QUEUE_NAMES, dispatchCampaign(), dispatchGlobalInbound(), dispatchInbound() (+14 more)

### Community 44 - "chat-client.tsx"
Cohesion: 0.05
Nodes (45): bodySchema, GET(), ownAgent(), Params, POST(), defaultSettings(), GET(), Params (+37 more)

### Community 45 - "material-select.tsx"
Cohesion: 0.21
Nodes (7): GET(), guard(), POST(), Props, PublicPost, PublicPostCard(), getMainWorkspaceId()

### Community 46 - "getVerticalPack"
Cohesion: 0.16
Nodes (20): Params, POST(), Params, POST(), PUT(), GET(), Params, POST() (+12 more)
...
Cohesion: 0.15
Nodes (13): setLocale(), MarketingLayout(), SESSION_COOKIE_NAMES, COPY, BackToTop(), COPY, Footer(), MarketingMobileMenu() (+5 more)

### Community 52 - "social-links.tsx"
Cohesion: 0.07
Nodes (19): CHANNEL_LABELS, ChannelBadge(), ChannelIcon, ICON_TONES, ICONS, CHANNEL_ICONS, COPY, MobileChannelExplorer() (+11 more)
...
Cohesion: 0.11
Nodes (41): AdminVigentoPage(), CAPABILITIES, POST(), bodySchema, Params, POST(), POST(), recordRun() (+33 more)

### Community 57 - "vertical-bookings-vigento.test.ts"
Cohesion: 0.11
Nodes (21): BrandHeader(), NAV_ITEMS, NavItem, NavList(), AdminLayout(), metadata, MobileNavTrigger(), adminLogout() (+13 more)
...
Cohesion: 0.26
Nodes (10): GET(), ACTIVE_APPOINTMENT_STATUSES, BookingError, bookInTransaction(), BookResult, findAppointmentWithRelations(), listAvailableSlots(), addMinutes() (+2 more)
...
Cohesion: 0.32
Nodes (11): appHeaders(), asRecord(), ChatOptions, ChatToolCall, DEFAULT_MAX_PRICE, firstChoice(), maxPriceFor(), parseUsage() (+3 more)

### Community 67 - "chat-orchestrator.ts"
Cohesion: 0.18
Nodes (16): bodySchema, Params, POST(), campaignDeliveryText(), CampaignJobData, processCampaign(), processRecipient(), SEND_INTERVAL_MS (+8 more)

### Community 68 - "ingest.ts"
Cohesion: 0.29
Nodes (9): GET(), GET(), POST(), AppointmentsPage(), listAppointmentsForDate(), listBookingServices(), serviceSlug(), dateKeyInTimeZone() (+1 more)
...
Cohesion: 0.20
Nodes (17): chunkFaq(), ChunkOptions, chunkText(), hardSplit(), splitBySentence(), splitLongFaqPair(), contextualChunk(), IngestionJobData (+9 more)
...
Cohesion: 0.11
Nodes (29): POST(), POST(), POST(), { handlers, auth, signOut }, onRequestError(), register(), captureDebug(), captureInfo() (+21 more)
...
Cohesion: 0.09
Nodes (21): agent_hint_body(), agent_hint_title(), AgentsPage(), PLAN_KEY, CHANNELS, IntegrationsPage(), AMOUNTS_IRR, CreditTopup() (+13 more)
...
Cohesion: 0.10
Nodes (22): Message, Proposal, QUICK_PROMPTS, VigentoAdminConsole(), WELCOME, Msg, TestPlayground(), VoiceRecorder (+14 more)
...
Cohesion: 0.06
Nodes (36): DocsHomePage(), metadata, DocPageRoute(), generateMetadata(), generateMetadata(), PAGE_COPY, SITE_URL, SOLUTION_META (+28 more)
...
Cohesion: 0.11
Nodes (22): DELETE(), Params, GET(), POST(), GET(), PATCH(), DashboardLayout(), metadata (+14 more)
...
Cohesion: 0.07
Nodes (56): bodySchema, Params, POST(), appBaseUrl(), GET(), appBaseUrl(), createSchema, DELETE() (+48 more)
...
Cohesion: 0.16
Nodes (15): MODEL_ALIASES, detectRole(), extractVigentoDraft(), fallbackVigentoDraft(), recommendedChannels, roleKeys, vigentoDraftSchema, vigentoSystemPrompt() (+7 more)
...
Cohesion: 0.09
Nodes (29): AdminAgentDetailPage(), CHANNEL_LABEL, AdminConversationDetailPage(), CHANNEL_LABEL, STATUS_LABEL, AdminConversationsPage(), CHANNEL_LABEL, STATUS_META (+21 more)
...
Cohesion: 0.09
Nodes (29): confirmSchema, Params, POST(), DELETE(), encryptSensitiveFields(), GET(), ownIntegration(), Params (+21 more)
...
Cohesion: 0.11
Nodes (17): AiModelPolicyForm(), formatUSD(), ModelAlias, ModelOption, Notice, Policy, ContactDetailEditor(), Stage (+9 more)
...
Cohesion: 0.15
Nodes (20): adminLogin(), AdminLoginState, AdminLoginForm(), initial, AdminLoginPage(), metadata, ADMIN_COOKIE, AdminLoginResult (+12 more)
...
Cohesion: 0.09
Nodes (35): DELETE(), GET(), ownAgent(), Params, PUT(), putSchema, GET(), Params (+27 more)
...
Cohesion: 0.05
Nodes (41): RangeTabs(), fmtBytes(), Metrics, Sample, ServerStatsWidget(), AccessKey, AccessRow(), StoreAccessSettings() (+33 more)
...
Cohesion: 0.40
Nodes (3): OtpRateLimitError, mocks, originalEnv
...
Cohesion: 0.22
Nodes (11): Props, PublicBlogPostPage(), TrendSpark(), getPopularPosts(), loadPopularPosts, PopularCard(), PopularPosts(), PostPreview (+3 more)
...
Cohesion: 0.11
Nodes (32): logout(), BuildMode, Props, Header(), MobileNav(), getDashboardNavForProfile(), getDashboardNavFromModules(), Sidebar() (+24 more)

### Community 275 - "zarinpay.ts"
Cohesion: 0.14
Nodes (19): POST(), appUrl(), bodySchema, POST(), createNowPaymentsInvoice(), getApiKey(), NOWPAYMENTS_PAID_STATUSES, NowPaymentsInvoiceResult (+11 more)
...
- **Why does `cn()` connect `react-dom` to `page-header.tsx`, `prisma.ts`, `models.ts`, `page.tsx`, `session.ts`, `woo-connect-wizard.tsx`, `registry.ts`, `commercial-config.ts`, `rateLimit`, `config.ts`, `route.ts`, `layout.tsx`, `trend-chart.tsx`, `page.tsx`, `social-links.tsx`, `route.ts`, `vertical-bookings-vigento.test.ts`, `iphone-preview.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `customer-identification.ts`, `route.ts`, `automation-manager.tsx`, `scheduler.ts`, `page.tsx`, `validation.ts`, `logo.tsx`, `automation-card.tsx`, `neural-network-primitives.tsx`, `vigento-actions.ts`, `page.tsx`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `getCurrentUser()` connect `chat-client.tsx` to `route.ts`, `cn`, `ui.tsx`, `session-revalidation.test.ts`, `embeddings.ts`, `route.ts`, `chat-engine.ts`, `campaign-composer.tsx`, `prisma.ts`, `syncOnboarding`, `activity.ts`, `route.ts`, `zarinpay.ts`, `commercial-config.ts`, `woocommerce.ts`, `route.ts`, `route.ts`, `getVerticalPack`, `route.ts`, `layout.tsx`, `low-credit-alert.ts`, `types.ts`, `helpers.ts`, `global-error.tsx`, `chat-orchestrator.ts`, `ingest.ts`, `charts.ts`, `PageHeader`, `dispatchProductEmbed`, `conversation-thread.tsx`, `route.ts`, `wp-content.ts`, `service.ts`, `route.ts`, `media-uploader.tsx`, `route.ts`, `route.ts`, `route.ts`, `admin-broadcast-form.tsx`?**
