...
## Corpus Check
- 726 files · ~537,352 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4237 nodes · 9927 edges · 271 communities (242 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d10ca694`
...
- `AgentGrowthPanel()` --calls--> `cn()`  [EXTRACTED]
  app/(dashboard)/agents/[agentId]/page.tsx → lib/utils.ts
- `ContactsPage()` --indirect_call--> `value()`  [INFERRED]
  app/(dashboard)/contacts/page.tsx → lib/config/production-env.ts

## Import Cycles
- None detected.

## Communities (271 total, 29 thin omitted)

### Community 0 - "automation.ts"
Cohesion: 0.10
Nodes (49): AutomationAction, AutomationContext, AutomationPolicy, AutomationRow, AutomationTrigger, checkUserFollows(), commentDmTarget(), DEFAULT_AUTOMATION_POLICY (+41 more)
...
Cohesion: 0.09
Nodes (23): AgentCatalogPage(), EditAutomationPage(), NewAutomationPage(), AgentKnowledgePage(), EditInstagramAutomationPage(), NewInstagramAutomationPage(), InstagramWorkspacePage(), DigitalMenuDashboardPage() (+15 more)
...
Cohesion: 0.14
Nodes (15): generateMetadata(), PAGE_COPY, SITE_URL, SOLUTION_META, SOLUTION_META_EN, SolutionPage(), getBlogEntries, sitemap() (+7 more)
...
Cohesion: 0.06
Nodes (50): AgentWizard(), BUSINESS_PRESETS, channelLabel(), ConfigDraft, CreatedAgent, draftFromRole(), FormState, NaturalConversationControls() (+42 more)

### Community 10 - "page.tsx"
Cohesion: 0.13
Nodes (23): buildOrderContext(), extractOrderId(), FA_STATUS, formatDate(), safeValue(), applyContactIdentity(), channelIdField(), consentState() (+15 more)

### Community 11 - "models.ts"
Cohesion: 0.09
Nodes (29): confirmSchema, Params, POST(), DELETE(), Params, PATCH(), GET(), POST() (+21 more)

### Community 12 - "captureError"
Cohesion: 0.09
Nodes (40): buildSystemPrompt(), bumpProductQueries(), GenerateReplyResult, hydrateSystemPrompt(), persistHandoff(), persistInboundTurnMessage(), prepareTurn(), StartChatResult (+32 more)
...
Cohesion: 0.10
Nodes (22): AgentAnalyticsPage(), AnalyticsPage(), daysAgo(), nfFa(), STAGE_LABELS_EN, STAGE_LABELS_FA, ContactRow, ContactsView() (+14 more)
...
Cohesion: 0.07
Nodes (50): decrypt(), refreshLongLivedToken(), crawlUrlToKnowledge(), refreshStaleUrlKnowledge(), cleanupOldRecords(), CleanupResult, NotifyParams, notifyWorkspace() (+42 more)

### Community 17 - "page.tsx"
Cohesion: 0.07
Nodes (39): ContactDetailPage(), CHANNEL_LABELS_FA, ConversationsPage(), SalesFilter, VALID_CHANNELS, VALID_SALES_FILTERS, VALID_STATUSES, CampaignComposer() (+31 more)

### Community 18 - "activity.ts"
Cohesion: 0.16
Nodes (18): onRequestError(), register(), sendPurchaseConfirmation(), captureError(), captureLog(), captureWarning(), emitConsole(), errorDetails() (+10 more)

### Community 19 - "registry.ts"
Cohesion: 0.16
Nodes (16): AgentSparkline(), MessageBuilder(), ChannelSettingsCard(), SocialProof(), key(), Env, ProductionEnvReport, REQUIRED (+8 more)
...
Cohesion: 0.10
Nodes (40): handleManualSync(), loadManualIntegration(), allAgentIds(), assignProduct(), authHeader(), availableCategorySlug(), canonicalize(), categoryExternalId() (+32 more)
...
Cohesion: 0.13
Nodes (15): Avatar(), ChatLinkClient(), errorText(), Intro(), isRetryableError(), Msg, nextId(), ProductCard (+7 more)

### Community 32 - "layout.tsx"
Cohesion: 0.08
Nodes (46): AccountStatus(), AdminAiPage(), formatProviderUSD(), formatRequestUSD(), formatRial(), ManagedModels(), ModelUsageTable(), parseRange() (+38 more)

### Community 33 - "package.json"
Cohesion: 0.18
Nodes (15): appUrl(), GET(), handleCallback(), POST(), readPid(), activateSubscriptionPayment(), persistSubscription(), createZarinPayPayment() (+7 more)
...
Cohesion: 0.18
Nodes (17): buildTrend(), daysAgo(), isRecord(), MODULE_META, OverviewPage(), percentDelta(), PLAN_NAMES_FA, ChecklistItem (+9 more)

### Community 37 - "page.tsx"
Cohesion: 0.18
Nodes (21): generateMetadata(), Props, PublicBlogPostPage(), AdminBlogManager(), AdminPostRow, STATUS_BADGE_CLS, STATUS_LABELS_EN, STATUS_LABELS_FA (+13 more)
...
Cohesion: 0.10
Nodes (35): entryOwnerIds(), getContactName(), handleInbound(), handleInstagramGlobalInbound(), IgWebhookEntry, markAssistantDelivery(), persistFixedAssistantReply(), persistInboundOnly() (+27 more)

### Community 42 - "route.ts"
Cohesion: 0.11
Nodes (32): appUrl(), GET(), POST(), buildInstagramOAuthConfig(), buildInstagramAuthUrl(), exchangeCodeForUserToken(), exchangeForLongLivedToken(), INSTAGRAM_OAUTH_SCOPES (+24 more)

### Community 43 - "jobs.ts"
Cohesion: 0.13
Nodes (25): bodySchema, GET(), ownAgent(), Params, PUT(), deleteContent(), handleWpContentWebhook(), upsertContent() (+17 more)

### Community 44 - "chat-client.tsx"
Cohesion: 0.06
Nodes (34): defaultSettings(), GET(), Params, PATCH(), patchSchema, REPLY_POLICIES, GET(), ownAgent() (+26 more)
...
Cohesion: 0.15
Nodes (15): GET(), GET(), nonNegativeInt, planSchema, positiveInt, PUT(), schema, GET() (+7 more)
...
Cohesion: 0.15
Nodes (17): DELETE(), encryptSensitiveFields(), GET(), ownIntegration(), Params, PATCH(), patchSchema, SENSITIVE_FIELDS (+9 more)

### Community 51 - "page.tsx"
Cohesion: 0.07
Nodes (28): baleAdapter(), getBaleBotInfo(), setBaleWebhook(), reactAfterInstagramReply(), ResolvedChannel, getInstagramInfo(), setInstagramWebhook(), getBotInfo() (+20 more)
...
Cohesion: 0.17
Nodes (22): AdminVigentoPage(), CAPABILITIES, GET(), PUT(), schema, inputSchema, POST(), DraftAgent (+14 more)

### Community 57 - "vertical-bookings-vigento.test.ts"
Cohesion: 0.09
Nodes (22): BrandHeader(), NAV_ITEMS, NavItem, NavList(), AdminLayout(), metadata, MobileNavTrigger(), adminLogout() (+14 more)
...
Cohesion: 0.14
Nodes (16): doSignOut(), GET(), POST(), { handlers, auth, signOut }, isPlatformOwnerPhone(), ExtractedIdentity, extractEnglishName(), extractIdentity() (+8 more)
...
Cohesion: 0.15
Nodes (14): agent_hint_body(), agent_hint_title(), AgentsPage(), isOrderStatus(), ORDER_STATUSES, OrdersPage(), OrderStatus, shortStoreUrl() (+6 more)
...
Cohesion: 0.16
Nodes (19): bodySchema, Params, POST(), campaignDeliveryText(), CampaignJobData, processCampaign(), processRecipient(), SEND_INTERVAL_MS (+11 more)
...
Cohesion: 0.13
Nodes (10): Props, PublicPost, PublicPostCard(), TrendSpark(), getPopularPosts(), loadPopularPosts, PopularCard(), PopularPosts() (+2 more)

### Community 73 - "booking-manager.tsx"
Cohesion: 0.19
Nodes (19): chunkFaq(), ChunkOptions, chunkText(), hardSplit(), splitBySentence(), splitLongFaqPair(), contextualChunk(), processIngestion() (+11 more)
...
Cohesion: 0.23
Nodes (8): AdminAgentsPage(), EmptyState(), LevelBadge(), ClearErrorLogsButton(), MiniTrend(), computeTrend(), Sparkline(), TrendDirection

### Community 76 - "page.tsx"
Cohesion: 0.16
Nodes (20): bodySchema, Params, POST(), POST(), POST(), bodySchema, POST(), GET() (+12 more)
...
Cohesion: 0.27
Nodes (9): execFileAsync, hasFfmpeg(), MIME_TO_EXT, POST(), publicBaseUrl(), transcodeToInstagramAudio(), UploadedFile, rateLimitCost() (+1 more)

### Community 81 - "API"
Cohesion: 0.27
Nodes (9): buildOperatorAlertKeyboard(), buildOperatorMenuKeyboard(), normalizeAppUrl(), OperatorBotCallback, operatorWebhookSecret(), parseOperatorBotCallback(), TelegramInlineKeyboardButton, mocks (+1 more)

### Community 82 - "getEffectivePlanDefs"
Cohesion: 0.12
Nodes (20): EmailMessage, escapeHtml(), notifyOps(), sendEmail(), NotificationJobData, processNotification(), createQueueConnection(), QUEUE_NAMES (+12 more)
...
Cohesion: 0.24
Nodes (7): AdminDatabasePage(), PageHeader(), adminVisibleDatabaseClause(), DATABASE_MODELS, DIRECT_WORKSPACE_MODELS, readDatabaseModel(), serializeValue()
...
Cohesion: 0.13
Nodes (21): AdminPaymentsPage(), AdminPaymentDetailPage(), GATEWAY_BADGE, PLAN_BADGE, STATUS_BADGE, StatusSummary(), BADGE_TONES, BadgeTone (+13 more)

### Community 107 - "automation-card.tsx"
Cohesion: 0.26
Nodes (11): ChangeDetail, MODULES, VerticalChangeNotice(), BusinessProfileStep(), ICONS, SubStep, DetailsStep(), getBusinessServiceOptions() (+3 more)
...
Cohesion: 0.20
Nodes (13): avatarResponse(), GET(), Params, unavailable(), ALLOWED_IMAGE_TYPES, fetchTrustedInstagramAvatar(), isTrustedInstagramAvatarUrl(), ProxiedAvatar (+5 more)
...
Cohesion: 0.09
Nodes (30): baseUrl(), bodySchema, Params, POST(), WEBHOOK_PATH, bodySchema, GET(), ownAgent() (+22 more)

### Community 123 - "page.tsx"
Cohesion: 0.17
Nodes (21): ConversationThreadPage(), ConversationDeleteAction(), ConversationThread(), InboundSource, InboundSourceKind, inboundSourceLabel(), readInboundSource(), buildFallbackSummary() (+13 more)

### Community 125 - "normalizeChatLinkSettings"
Cohesion: 0.20
Nodes (17): appBaseUrl(), GET(), appBaseUrl(), createSchema, DELETE(), GET(), maskBotToken(), PATCH() (+9 more)
...
Cohesion: 0.21
Nodes (20): answerCallback(), appUrl, escapeHtml(), getOpenAlerts(), handleCallback(), healthText(), helpText(), homeText() (+12 more)
...
Cohesion: 0.28
Nodes (5): NewProductPage(), EditProductPage(), CategoryOption, ProductForm(), ProductFormData

### Community 148 - "route.ts"
Cohesion: 0.11
Nodes (25): AdminCommercialEvent, AdminCommercialEventKind, adminCommercialSmsPhone(), captureAdminCommercialSmsError(), compact(), formatAmount(), gatewayLabelFa(), notifyAdminCommercialEvent() (+17 more)
...
Cohesion: 0.09
Nodes (25): ConversationPanel(), HandoffAlertProp, MESSENGER_META, clampPercent(), humanizeCode(), LABELS, Locale, OBJECTION_LABELS (+17 more)
...
Cohesion: 0.10
Nodes (23): Message, Proposal, QUICK_PROMPTS, VigentoAdminConsole(), WELCOME, Msg, VoiceRecorder, ChatComposer (+15 more)
...
Cohesion: 0.12
Nodes (19): GET(), PATCH(), Props, BOOKING_AGENT_TOOLS, BOOKING_TOOL_SYSTEM_INSTRUCTION, cancelSchema, executeBookingAgentTool(), slotsSchema (+11 more)
...
Cohesion: 0.06
Nodes (34): ProductsPage(), AiModelPolicyForm(), formatUSD(), ModelAlias, ModelOption, Notice, Policy, ContactDetailEditor() (+26 more)
...
Cohesion: 0.12
Nodes (19): POST(), recordRun(), requestSchema, hasCompleteCustomerIdentity(), detectRole(), extractVigentoDraft(), fallbackVigentoDraft(), recommendedChannels (+11 more)
...
Cohesion: 0.11
Nodes (26): PATCH(), DELETE(), GET(), ownAgent(), Params, PUT(), putSchema, GET() (+18 more)
...
Cohesion: 0.06
Nodes (33): AttentionItem(), COPY, ToggleBtn(), SectionHeader(), MediaItem, MediaKind, MediaUploader(), TabButton() (+25 more)
...
Cohesion: 0.10
Nodes (24): AgentSettingsPage(), BUSINESSES, NewAgentPage(), BillingPage(), PLAN_KEY, assurances, metadata, PLAN_FA_NAMES (+16 more)
...
Cohesion: 0.19
Nodes (20): ProductDetailPage(), appendSalesGuidance(), buildDeterministicTurnReply(), generateReply(), GenerateReplyOptions, AttrRow, cleanDescriptionForChat(), extractListItems() (+12 more)
...
Cohesion: 0.16
Nodes (14): parseAssistant(), TestPlayground(), parseProductShowcaseContent(), productTokenBounds(), formatCount(), INITIAL_SCROLL, ProductShowcaseRail(), ScrollState (+6 more)

### Community 244 - "store-integrations-section.tsx"
Cohesion: 0.19
Nodes (11): CHANNELS, IntegrationsPage(), formatWooSyncResult(), SyncFeedback, WooSyncResult, entityLabel(), IntegrationCard(), isIntegrationConnected() (+3 more)
...
Cohesion: 0.38
Nodes (4): CategoriesPage(), BackButton(), CategoryNode, CategoryTree()
...
Cohesion: 0.50
Nodes (3): ConversationActions(), Status, Switch()
...
Cohesion: 0.07
Nodes (34): AdminAgentDetailPage(), CHANNEL_LABEL, AdminConversationDetailPage(), CHANNEL_LABEL, STATUS_LABEL, AdminConversationsPage(), CHANNEL_LABEL, STATUS_META (+26 more)
...
Cohesion: 0.18
Nodes (10): AgentBuilderEntry(), BuildMode, Props, Props, CapabilityOptions(), Locale, OPTION_META, optionLabel() (+2 more)
...
Cohesion: 0.20
Nodes (16): logout(), Header(), MobileNav(), getDashboardNavForProfile(), getDashboardNavFromModules(), Sidebar(), BUSINESS_SERVICE_OPTIONS, BUSINESS_TYPES (+8 more)
...
- **Why does `cn()` connect `react-dom` to `platform-stats.ts`, `ui.tsx`, `conversation-reply-delivery.test.ts`, `prisma.ts`, `page-header.tsx`, `auth.config.ts`, `BusinessTypeValue`, `layout.tsx`, `page.tsx`, `syncOnboarding`, `page.tsx`, `woo-connect-wizard.tsx`, `commercial-config.ts`, `rateLimit`, `automation-form.tsx`, `setup-whatsapp-bridge.sh`, `layout.tsx`, `oauth.ts`, `page.tsx`, `vigent-woo.php`, `route.ts`, `social-links.tsx`, `vertical-bookings-vigento.test.ts`, `iphone-preview.tsx`, `helpers.ts`, `global-error.tsx`, `page.tsx`, `ingest.ts`, `PageHeader`, `route.ts`, `page.tsx`, `wp-content.ts`, `logo.tsx`, `material-select.tsx`, `service.ts`, `automation-card.tsx`, `page.tsx`, `neural-network-primitives.tsx`, `store-integrations-section.tsx`, `page.tsx`, `rag.ts`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `getCurrentUser()` connect `chat-client.tsx` to `route.ts`, `prisma.ts`, `route.ts`, `campaign-composer.tsx`, `models.ts`, `commercial-config.ts`, `woocommerce.ts`, `route.ts`, `route.ts`, `jobs.ts`, `material-select.tsx`, `layout.tsx`, `route.ts`, `low-credit-alert.ts`, `chat-orchestrator.ts`, `service-health-panel.tsx`, `page.tsx`, `conversation-thread.tsx`, `route.ts`, `automation-manager.tsx`, `scheduler.ts`, `model-select.tsx`, `validation.ts`, `popular-posts.tsx`, `wp-content.ts`, `material-select.tsx`, `route.ts`, `service.ts`, `media-uploader.tsx`, `route.ts`, `route.ts`, `whatsapp.ts`, `route.ts`, `vigento-actions.ts`, `readBotToken`, `normalizeChatLinkSettings`, `admin-broadcast-form.tsx`, `route.ts`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `wp-content.ts`, `@prisma/client`, `page.tsx`, `order-context.ts`, `isAdminAuthed`, `index.ts`?**
