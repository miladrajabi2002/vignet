...
## Corpus Check
- 664 files · ~497,719 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3944 nodes · 9203 edges · 254 communities (225 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 93 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b369e3ca`
...
4. `captureError()` - 53 edges
5. `rateLimit()` - 44 edges
6. `checkWorkspaceActive()` - 38 edges
7. `isAdminAuthed()` - 35 edges
8. `buffer` - 35 edges
9. `Vigent_Woo_Core` - 35 edges
10. `syncOnboarding()` - 34 edges
...
## Communities (254 total, 29 thin omitted)

### Community 0 - "automation.ts"
Cohesion: 0.11
Nodes (43): AutomationAction, AutomationPolicy, AutomationRow, AutomationTrigger, checkUserFollows(), DEFAULT_AUTOMATION_POLICY, executeAction(), isReplyMode() (+35 more)

### Community 1 - "cn"
Cohesion: 0.15
Nodes (20): POST(), bodySchema, GET(), Params, POST(), bodySchema, POST(), bodySchema (+12 more)

### Community 2 - "ui.tsx"
Cohesion: 0.07
Nodes (44): GET(), bodySchema, Params, POST(), baleAdapter(), getBaleBotInfo(), setBaleWebhook(), readBotToken() (+36 more)

### Community 3 - "loader.js"
Cohesion: 0.11
Nodes (48): actionChip(), applyConfig(), applyViewportHeight(), autoGrow(), bubble(), clearIntro(), compactProductText(), contrast() (+40 more)

### Community 4 - "prisma.ts"
Cohesion: 0.05
Nodes (50): defaultSettings(), GET(), Params, PATCH(), patchSchema, REPLY_POLICIES, DELETE(), GET() (+42 more)
...
Cohesion: 0.15
Nodes (20): AttentionItem(), buildTrend(), daysAgo(), isRecord(), MODULE_META, OverviewPage(), percentDelta(), PLAN_NAMES_FA (+12 more)

### Community 7 - "charts.ts"
Cohesion: 0.18
Nodes (10): GET(), guard(), POST(), GET(), guard(), Props, blogCategorySchema, blogPostSchema (+2 more)
...
Cohesion: 0.06
Nodes (46): AgentWizard(), BUSINESS_PRESETS, channelLabel(), ConfigDraft, CreatedAgent, draftFromRole(), FormState, NaturalConversationControls() (+38 more)

### Community 10 - "page.tsx"
Cohesion: 0.18
Nodes (16): channelIdField(), consentState(), ContactRow, firstValue(), laterDate(), withContactIdentityLock(), withContactIdentityLocks(), mergeContacts() (+8 more)
...
Cohesion: 0.14
Nodes (16): ChatLinkClient(), errorText(), Intro(), Msg, nextId(), parseAssistant(), ProductCard, Props (+8 more)
...
Cohesion: 0.19
Nodes (12): getWorkspaceId(), PublicBlogIndexPage(), PublicPost, PublicPostCard(), TrendSpark(), getPopularPosts(), loadPopularPosts, PopularCard() (+4 more)

### Community 16 - "session.ts"
Cohesion: 0.09
Nodes (24): metadata, OnboardingPage(), BusinessProfileStep(), DetailsStep(), EASE, ICONS, OnboardingFlow(), Phase (+16 more)

### Community 17 - "page.tsx"
Cohesion: 0.10
Nodes (21): AgentAnalyticsPage(), AnalyticsPage(), daysAgo(), nfFa(), STAGE_LABELS_EN, STAGE_LABELS_FA, ContactRow, ContactsView() (+13 more)

### Community 18 - "activity.ts"
Cohesion: 0.23
Nodes (12): GET(), PATCH(), DashboardLayout(), metadata, Header(), OnboardingShell(), STEPS, computeOnboarding() (+4 more)

### Community 19 - "registry.ts"
Cohesion: 0.23
Nodes (13): batchSchema, digest(), eventSchema, normalizeSiteUrl(), parseDelivery(), pluginVersionFromHeaders(), POST(), sameSiteUrl() (+5 more)
...
Cohesion: 0.11
Nodes (22): getContactName(), persistFixedAssistantReply(), persistInboundOnly(), processChannelInbound(), profileFields(), NOTE: do NOT add sender.id here — that's the customer who messaged, reactAfterInstagramReply(), ResolvedChannel (+14 more)
...
Cohesion: 0.10
Nodes (42): handleManualSync(), loadManualIntegration(), allAgentIds(), assignProduct(), authHeader(), availableCategorySlug(), canonicalize(), categoryExternalId() (+34 more)
...
Cohesion: 0.08
Nodes (33): AdminPaymentsPage(), AdminPaymentDetailPage(), GATEWAY_BADGE, PLAN_BADGE, STATUS_BADGE, StatusSummary(), AdminRevenuePage(), fmtDay() (+25 more)
...
Cohesion: 0.09
Nodes (39): DELETE(), Params, PATCH(), settingsSchema, GET(), Params, POST(), PUT() (+31 more)

### Community 35 - "auth.ts"
Cohesion: 0.17
Nodes (23): notifyWorkspace(), sendActivationCompleteSms(), sendActivationReminderSms(), sendPatternSms(), sendSubscriptionExpiringSms(), sendTrialExpiringSms(), alertSilentChannels(), cleanupOldRecords() (+15 more)
...
Cohesion: 0.14
Nodes (17): getReplyPriceIRR(), getRoleTemplate(), detectRole(), extractVigentoDraft(), fallbackVigentoDraft(), recommendedChannels, roleKeys, vigentoDraftSchema (+9 more)
...
Cohesion: 0.12
Nodes (19): isOrderStatus(), ORDER_STATUSES, OrdersPage(), OrderStatus, shortStoreUrl(), STATUS_TRANSLATION_KEYS, statusClassName(), ProductsPage() (+11 more)

### Community 42 - "route.ts"
Cohesion: 0.18
Nodes (12): ChatAgent, StartChatParams, detectUnanswered(), evaluateHandoffPolicy(), formatReason(), HandoffDecision, HandoffPolicyInput, HandoffReasonCode (+4 more)

### Community 43 - "jobs.ts"
Cohesion: 0.13
Nodes (24): BodySchema, POST(), bodySchema, GET(), ownAgent(), Params, PUT(), deleteChunksForProduct() (+16 more)

### Community 44 - "chat-client.tsx"
Cohesion: 0.18
Nodes (11): agent_hint_body(), agent_hint_title(), AgentsPage(), DigitalMenuDashboardPage(), ServicesPage(), PageHeader(), IMPORTANT: by request, there is NO kicker / eyebrow text above the title., MenuShareCard() (+3 more)

### Community 45 - "material-select.tsx"
Cohesion: 0.19
Nodes (13): AgentSettingsPage(), BUSINESSES, NewAgentPage(), AgentSettingsData, grantIncludedPlanCredit(), planCreditGrantKey(), PlanCreditGrantResult, envInt() (+5 more)

### Community 46 - "getVerticalPack"
Cohesion: 0.10
Nodes (34): baseUrl(), bodySchema, Params, POST(), WEBHOOK_PATH, bodySchema, GET(), ownAgent() (+26 more)

### Community 47 - "vigent-woo.php"
Cohesion: 0.25
Nodes (3): vigent_woo_migrate_4_2_0(), vigent_woo_migrate_existing_users(), vigent_woo_setup_cron()

### Community 48 - "config.ts"
Cohesion: 0.19
Nodes (10): POST(), POST(), POST(), POST(), POST(), MessengerType, CapturedPayload, categorizePayload() (+2 more)
...
Cohesion: 0.08
Nodes (36): CAPABILITIES, PUT(), schema, assurances, metadata, Meter(), ModelSelect(), TIER_ICON (+28 more)
...
Cohesion: 0.19
Nodes (14): sendPurchaseConfirmation(), AdminCreditTopupPatternData, AdminSubscriptionPatternData, formatPersianDate(), generateCode(), IppanelMeta, ippanelSend(), isSmsConfigured() (+6 more)
...
Cohesion: 0.08
Nodes (19): ChannelsSection, FaqSection, FeaturesSection, HOME_METADATA_COPY, LivePlatformStats(), PricingSection, STRUCTURED_DATA_COPY, VigentoSection (+11 more)
...
Cohesion: 0.15
Nodes (10): NewAutomationPage(), NewInstagramAutomationPage(), InstagramWorkspacePage(), AutomationForm(), TabDef, AutomationType, IMPORTANT: we redirect to `/api/auth/force-logout` (NOT directly to /login), SessionUser (+2 more)

### Community 86 - "page.tsx"
Cohesion: 0.16
Nodes (10): MarketingLayout(), SESSION_COOKIE_NAMES, COPY, BackToTop(), COPY, Footer(), COPY, Navbar() (+2 more)
...
Cohesion: 0.21
Nodes (11): AgentChannelsPage(), WEBHOOK_PATH, ChatLinkChannel(), PendingWhatsappNumber, QrState, StatusResponse, WhatsAppNumberPicker(), WhatsAppQrConnect() (+3 more)
...
Cohesion: 0.21
Nodes (9): AgentLayout(), AgentTabItem, AgentTabs(), ICONS, ChangeDetail, MODULES, VerticalChangeNotice(), telegramMarkdownToHtml() (+1 more)

### Community 103 - "conversation.ts"
Cohesion: 0.29
Nodes (10): extractProductTerms(), fetchCatalogProducts(), historyForProductTurn(), normalizePersianText(), planProductRequest(), PRODUCT_STOP_WORDS, ProductRequestPlan, requestedProductCount() (+2 more)
...
Cohesion: 0.12
Nodes (20): Params, POST(), appBaseUrl(), createSchema, encryptSensitiveFields(), GET(), normalizeWooStoreUrl(), POST() (+12 more)
...
Cohesion: 0.14
Nodes (20): GET(), POST(), POST(), secretsMatch(), GET(), POST(), handleInbound(), handleInstagramGlobalInbound() (+12 more)
...
Cohesion: 0.15
Nodes (14): generateMetadata(), PAGE_COPY, SITE_URL, SOLUTION_META, SOLUTION_META_EN, SolutionPage(), SOLUTIONS_EN, getLocalizedSolution() (+6 more)
...
Cohesion: 0.11
Nodes (17): AgentLearningPage(), CategoriesPage(), NewProductPage(), VigentoPage(), LearningCenter(), LearningItem, ContactDeleteAction(), ContactDetailEditor() (+9 more)

### Community 122 - "formatDateTime"
Cohesion: 0.08
Nodes (34): confirmSchema, Params, POST(), DELETE(), encryptSensitiveFields(), GET(), ownIntegration(), Params (+26 more)

### Community 123 - "page.tsx"
Cohesion: 0.06
Nodes (44): ContactDetailPage(), ConversationThreadPage(), CHANNEL_LABELS_FA, ConversationsPage(), SalesFilter, VALID_CHANNELS, VALID_SALES_FILTERS, VALID_STATUSES (+36 more)

### Community 125 - "normalizeChatLinkSettings"
Cohesion: 0.17
Nodes (18): DELETE(), GET(), ownAgent(), Params, PUT(), putSchema, GET(), Params (+10 more)
...
Cohesion: 0.14
Nodes (32): AdminVigentoPage(), POST(), recordRun(), requestSchema, inputSchema, POST(), ConversationThread(), DraftAgent (+24 more)
...
Cohesion: 0.27
Nodes (8): bodySchema, Params, POST(), POST(), rateLimit(), audioFormat(), transcribeAudio(), TranscribeInput
...
Cohesion: 0.22
Nodes (19): DELETE(), GET(), guard(), Params, PATCH(), POST(), BlogEditor(), isFa() (+11 more)
...
Cohesion: 0.09
Nodes (19): AgentKnowledgePage(), BillingPage(), PLAN_KEY, AMOUNTS_IRR, CreditTopup(), NotificationBell(), NotificationItem, PlanCheckout() (+11 more)

### Community 197 - "service-health-panel.tsx"
Cohesion: 0.11
Nodes (29): bodySchema, Params, POST(), bodySchema, Params, POST(), campaignDeliveryText(), CampaignJobData (+21 more)

### Community 199 - "page.tsx"
Cohesion: 0.08
Nodes (48): AdminAgentDetailPage(), CHANNEL_LABEL, AdminAgentsPage(), AdminBlogPage(), AdminConversationDetailPage(), CHANNEL_LABEL, STATUS_LABEL, AdminConversationsPage() (+40 more)
...
### Community 203 - "wp-content.ts"
Cohesion: 0.23
Nodes (11): enqueueAdminCommercialSms(), processAdminCommercialSmsPayment(), RETRY_DELAYS_MS, retryAt(), sweepAdminCommercialSmsOutbox(), AiCreditTopupCapture, captureAiCreditTopupPayment(), mocks (+3 more)

### Community 204 - "chat-link-channel.tsx"
Cohesion: 0.22
Nodes (7): Avatar(), ChatLinkPreview(), COLOR_PRESETS, LinkState, CHAT_LINK_BACKGROUNDS, ChatLinkSettings, contrastOn()
...
Cohesion: 0.15
Nodes (19): adminLogin(), AdminLoginState, REASON_MESSAGES_FA, AdminLoginForm(), initial, AdminLoginPage(), metadata, ADMIN_COOKIE (+11 more)
...
### Community 219 - "otp-attempts.ts"
Cohesion: 0.52
Nodes (4): POST(), allowOtpVerificationAttempt(), isOTPValid(), mocks

### Community 223 - "ecosystem.config.js"
Cohesion: 0.50
Nodes (3): appRoot, path, whatsappRoot

### Community 229 - "tailwind-merge"
Cohesion: 0.28
...
Cohesion: 0.04
Nodes (65): AgentCatalogPage(), AiModelPolicyForm(), formatUSD(), ModelAlias, ModelOption, Notice, Policy, Message (+57 more)
...
Cohesion: 0.43
Nodes (5): OPTIONS(), OPTIONS(), Params, corsHeaders, corsOptions()

### Community 237 - "embeddings.ts"
Cohesion: 0.23
Nodes (14): buildCatalogBlock(), buildMessages(), buildServiceBlock(), CatalogProduct, CatalogService, formatPrice(), RagContext, retrieveContext() (+6 more)
...
Cohesion: 0.15
Nodes (19): { handlers, auth, signOut }, isPlatformOwnerPhone(), applyExtractedIdentity(), ExtractedIdentity, extractEnglishName(), extractIdentity(), extractPersianName(), buildOrderContext() (+11 more)
...
### Community 242 - "page.tsx"
Cohesion: 0.48
Nodes (6): generateMetadata(), getWorkspaceId(), Props, PublicBlogPostPage(), deriveSeoTitle(), renderMarkdown()

### Community 243 - "finance.ts"
Cohesion: 0.40
Nodes (5): GET(), PATCH(), Props, notifyAppointmentCancellation(), appointmentUpdateSchema

### Community 244 - "page.tsx"
Cohesion: 0.60
Nodes (4): generateMetadata(), getWorkspaceId(), Props, PublicBlogCategoryPage()

### Community 251 - "route.ts"
Cohesion: 0.83
Nodes (3): doSignOut(), GET(), POST()

## Knowledge Gaps
- **1194 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `mini-services/**`, `node_modules/**`, `metadata` (+1189 more)
...
- `neural-operation-graph.tsx` (2× useful, score=1.821329009)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `cn()` connect `react-dom` to `page-header.tsx`, `qr-config.ts`, `models.ts`, `captureError`, `session.ts`, `page.tsx`, `activity.ts`, `route.ts`, `commercial-config.ts`, `route.ts`, `layout.tsx`, `trend-chart.tsx`, `chat-client.tsx`, `page.tsx`, `route.ts`, `social-links.tsx`, `low-credit-alert.ts`, `iphone-preview.tsx`, `helpers.ts`, `route.ts`, `chat-orchestrator.ts`, `page.tsx`, `page.tsx`, `booking-manager.tsx`, `instagram.ts`, `PageHeader`, `wp-content.ts`, `page.tsx`, `automation-card.tsx`, `route.ts`, `logo.tsx`, `page.tsx`, `route.ts`, `vigento-actions.ts`, `page.tsx`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `@ricky0123/vad-web`, `tailwind-merge`, `@prisma/client`, `route.ts`, `model-select.tsx`, `isAdminAuthed`, `index.ts`, `page-header.tsx`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `getCurrentUser()` connect `prisma.ts` to `cn`, `ui.tsx`, `page-header.tsx`, `campaign-composer.tsx`, `page.tsx`, `dispatchIngestion`, `route.ts`, `activity.ts`, `registry.ts`, `woocommerce.ts`, `registry.ts`, `rateLimit`, `route.ts`, `route.ts`, `jobs.ts`, `getVerticalPack`, `layout.tsx`, `route.ts`, `service-health-panel.tsx`, `automation-manager.tsx`, `charts.ts`, `index.ts`, `route.ts`, `service.ts`, `validation.ts`, `route.ts`, `material-select.tsx`, `service.ts`, `route.ts`, `automation-card.tsx`, `media-uploader.tsx`, `route.ts`, `finance.ts`, `route.ts`, `vigento-actions.ts`, `formatDateTime`, `normalizeChatLinkSettings`?**
