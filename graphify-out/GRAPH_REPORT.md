...
## Corpus Check
- 609 files · ~439,715 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3551 nodes · 8300 edges · 235 communities (212 shown, 23 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `98afe2bf`
...
1. `getCurrentUser()` - 180 edges
2. `cn()` - 152 edges
3. `requireUser()` - 74 edges
4. `captureError()` - 48 edges
...
## Communities (235 total, 23 thin omitted)
...
### Community 1 - "cn"
Cohesion: 0.08
Nodes (22): RangeTabs(), AdminDatabasePage(), Badge(), EmptyState(), AiModelPolicyForm(), formatUSD(), ModelAlias, ModelOption (+14 more)
...
Cohesion: 0.09
Nodes (52): AddStoreForm(), DIRECTION_LABEL, ENTITY_LABEL, formatDate(), IntegrationCard(), StoreType, SyncLogEntry, TYPE_LABEL (+44 more)

### Community 4 - "prisma.ts"
Cohesion: 0.06
Nodes (38): GET(), ownAgent(), Params, POST(), saveSchema, DELETE(), ownAgent(), Params (+30 more)

### Community 5 - "chat-engine.ts"
Cohesion: 0.11
Nodes (31): buildSystemPrompt(), bumpProductQueries(), generateReply(), GenerateReplyOptions, GenerateReplyResult, hydrateSystemPrompt(), persistAssistantTurn(), persistHandoff() (+23 more)
...
Cohesion: 0.09
Nodes (15): AutomationForm(), defaultReplyMode(), emptyTextMessage(), FormState, KeywordFilter, MediaUploader, normalizeMessage(), PostFilter (+7 more)

### Community 9 - "prompt-builder.ts"
Cohesion: 0.14
Nodes (23): AgentSettingsForm(), BaseRoleKey, booleanOrDefault(), buildLayeredPrompt(), BUSINESS_ROLE_SPECS, BUSINESS_ROLE_TEMPLATES, BusinessRoleSpec, BusinessType (+15 more)
...
Cohesion: 0.11
Nodes (17): AgentWizard(), BUSINESS_PRESETS, channelLabel(), ConfigDraft, CreatedAgent, draftFromRole(), FormState, VigentoComposer() (+9 more)

### Community 12 - "captureError"
Cohesion: 0.08
Nodes (30): AdminBlogPage(), CHANNEL_LABEL, STATUS_META, GATEWAY_BADGE, PLAN_BADGE, STATUS_BADGE, AdminPagination(), BADGE_TONES (+22 more)
...
Cohesion: 0.11
Nodes (33): DELETE(), Params, settingsSchema, GET(), Params, POST(), PUT(), appUrl() (+25 more)

### Community 15 - "syncOnboarding"
Cohesion: 0.14
Nodes (20): EditAutomationPage(), InstagramAutomationContent(), normalizeSettings(), EditInstagramAutomationPage(), ChannelSettingsCard(), InstagramAutomationManager(), TabDef, TABS (+12 more)
...
Cohesion: 0.09
Nodes (23): AgentAnalyticsPage(), AnalyticsPage(), daysAgo(), nfFa(), ContactsPage(), STAGE_LABELS_EN, STAGE_LABELS_FA, ContactRow (+15 more)
...
Cohesion: 0.11
Nodes (22): FacebookPagesResult, IgHost, IgWebhook, instagramAdapter(), InstagramPageOption, IMPORTANT: do NOT skip messages based on folder flags., ResolvedHost, telegramMarkdownToHtml() (+14 more)

### Community 20 - "commercial-config.ts"
Cohesion: 0.09
Nodes (28): AdminPlatformSettingsPage(), GET(), nonNegativeInt, planSchema, positiveInt, PUT(), schema, MODEL_META (+20 more)

### Community 21 - "handler.ts"
Cohesion: 0.10
Nodes (27): getContactName(), handleInbound(), handleInstagramGlobalInbound(), persistFixedAssistantReply(), persistInboundOnly(), processChannelInbound(), profileFields(), NOTE: do NOT add sender.id here — that's the customer who messaged (+19 more)
...
Cohesion: 0.16
Nodes (11): NaturalConversationControls(), ChannelOption, ConversationFilters(), StatusKey, StatusOption, CategoryNode, CategoryTree(), MaterialSelect() (+3 more)

### Community 24 - "automation-form.tsx"
Cohesion: 0.06
Nodes (64): GET(), PATCH(), Props, bookingErrorResponse(), GET(), POST(), GET(), POST() (+56 more)
...
Cohesion: 0.16
Nodes (25): handleManualSync(), loadIntegration(), POST(), authHeader(), deleteProductFromWoo(), fetchWooJson(), findContactByEmail(), findContactByPhone() (+17 more)

### Community 28 - "config.ts"
Cohesion: 0.06
Nodes (54): bodySchema, GET(), ownAgent(), Params, POST(), bodySchema, GET(), Params (+46 more)
...
Cohesion: 0.18
Nodes (22): generateMetadata(), getWorkspaceId(), Props, PublicBlogPostPage(), AdminBlogManager(), AdminPostRow, STATUS_BADGE_CLS, STATUS_LABELS_EN (+14 more)
...
Cohesion: 0.14
Nodes (23): POST(), callEmbeddings(), embedCacheKey(), EmbedContext, embedText(), embedTexts(), getCachedEmbedding(), getEmbedContext() (+15 more)
...
Cohesion: 0.17
Nodes (5): EMPTY_CONFIG, LayerTab, NormalizedPromptConfig, PromptFormatConfig, PromptQAPair
...
Cohesion: 0.17
Nodes (22): bodySchema, Params, POST(), SummaryJobData, NotifyParams, notifyWorkspace(), createQueueConnection(), isQueueDisabled() (+14 more)
...
Cohesion: 0.12
Nodes (29): AdminVigentoPage(), CAPABILITIES, Meter(), ModelSelect(), TIER_ICON, PricingSection(), OpenRouterManagedModel, AGENT_MODELS (+21 more)

### Community 46 - "getVerticalPack"
Cohesion: 0.21
Nodes (15): GET(), PATCH(), AgentLayout(), DashboardLayout(), metadata, OnboardingPage(), SettingsPage(), computeOnboarding() (+7 more)
...
Cohesion: 0.10
Nodes (24): confirmSchema, Params, POST(), bodySchema, POST(), execFileAsync, hasFfmpeg(), MIME_TO_EXT (+16 more)
...
Cohesion: 0.12
Nodes (33): POST(), formatPersianDate(), generateCode(), IppanelMeta, ippanelSend(), isSmsConfigured(), OtpRateLimitError, planLabelFa() (+25 more)
...
Cohesion: 0.16
Nodes (14): Params, POST(), MessengerConfig, MessengerSettings, decrypt(), encrypt(), getKey(), sendOperatorTelegramNotification() (+6 more)
...
Cohesion: 0.11
Nodes (18): Message, Proposal, QUICK_PROMPTS, VigentoAdminConsole(), WELCOME, Msg, TestPlayground(), VoiceRecorder (+10 more)
...
Cohesion: 0.13
Nodes (24): logout(), AgentBuilderEntry(), BuildMode, Props, MobileNav(), getDashboardNavForProfile(), getDashboardNavFromModules(), Sidebar() (+16 more)
...
Cohesion: 0.18
Nodes (11): BusyAction, Feedback, fetchOperatorHealth(), GlassButton(), localeDate(), localeNumber(), OperatorChannelHealth, OperatorChannelInfo (+3 more)
...
Cohesion: 0.11
Nodes (38): AdminOverviewPage(), parseRange(), startOfToday(), LevelBadge(), Progress(), AdminUsagePage(), parseRange(), TYPE_LABEL (+30 more)

### Community 75 - "PageHeader"
Cohesion: 0.25
Nodes (17): LocalizedDatePicker(), PickerPosition, WEEKDAYS, formatDate(), asDate(), CalendarMonth, calendarMonthLength(), calendarMonthOffset() (+9 more)
...
Cohesion: 0.27
Nodes (11): assertSafeHttpUrl(), hostnameWithoutBrackets(), isBlockedIp(), isBlockedIpv4(), parseHttpUrl(), request(), resolvePublicAddress(), safeHttpGet() (+3 more)
...
Cohesion: 0.14
Nodes (13): ConversationPanel(), HandoffAlertProp, MESSENGER_META, NotificationBell(), NotificationItem, KbItem, KbStatus, Mode (+5 more)

### Community 86 - "page.tsx"
Cohesion: 0.24
Nodes (13): AdminAgentDetailPage(), CHANNEL_LABEL, AdminAgentsPage(), AdminConversationDetailPage(), CHANNEL_LABEL, STATUS_LABEL, AdminConversationsPage(), Card() (+5 more)
...
Cohesion: 0.13
Nodes (13): assurances, metadata, MobilePlanView, PLAN_TRANSLATION_KEY, MODEL_ALIASES, grantIncludedPlanCredit(), planCreditGrantKey(), PlanCreditGrantResult (+5 more)
...
Cohesion: 0.16
Nodes (13): GET(), PUT(), schema, GET(), BodySchema, POST(), DELETE(), GET() (+5 more)
...
Cohesion: 0.22
Nodes (12): appUrl(), GET(), handleCallback(), POST(), readPid(), AiCreditTopupCapture, captureAiCreditTopupPayment(), activateSubscriptionPayment() (+4 more)
...
Cohesion: 0.27
Nodes (10): POST(), schema, ADMIN_OWNER_PHONE, AdminActionInput, AdminActionPayload, createAdminActionToken(), executeAdminAction(), secret() (+2 more)
...
Cohesion: 0.13
Nodes (15): agent_hint_body(), agent_hint_title(), AgentsPage(), CHANNELS, IntegrationsPage(), DigitalMenuDashboardPage(), ServicesPage(), PageHeader() (+7 more)
...
Cohesion: 0.19
Nodes (9): BillingPage(), PLAN_KEY, AMOUNTS_IRR, CreditTopup(), PlanCheckout(), NOTE: lucide v1 removed brand icons (incl. Bitcoin) — Coins stands in for crypto, ReplyCreditEstimator(), getMonthlyMessageCount() (+1 more)
...
### Community 120 - "key"
Cohesion: 0.21
Nodes (12): ALLOWED, EXTENSION, POST(), POST(), createNowPaymentsInvoice(), getApiKey(), NOWPAYMENTS_PAID_STATUSES, NowPaymentsInvoiceResult (+4 more)

### Community 121 - "vigento-actions.ts"
Cohesion: 0.08
Nodes (27): AgentCatalogPage(), NewAutomationPage(), AgentKnowledgePage(), AgentLearningPage(), AgentSettingsPage(), BUSINESSES, NewAgentPage(), NewInstagramAutomationPage() (+19 more)

### Community 122 - "formatDateTime"
Cohesion: 0.10
Nodes (26): GET(), POST(), appBaseUrl(), createSchema, encryptSensitiveFields(), GET(), POST(), SENSITIVE_FIELDS (+18 more)

### Community 123 - "page.tsx"
Cohesion: 0.07
Nodes (35): ContactDetailPage(), CHANNEL_LABELS_FA, ConversationsPage(), VALID_CHANNELS, VALID_STATUSES, CampaignComposer(), DraftCampaign, Preview (+27 more)

### Community 125 - "normalizeChatLinkSettings"
Cohesion: 0.09
Nodes (35): PATCH(), DELETE(), GET(), ownAgent(), Params, PUT(), putSchema, GET() (+27 more)
...
Cohesion: 0.17
Nodes (23): bodySchema, Params, POST(), POST(), recordRun(), requestSchema, inputSchema, POST() (+15 more)
...
Cohesion: 0.17
Nodes (16): EditProductPage(), ProductDetailPage(), AgentSparkline(), SocialProof(), key(), Env, ProductionEnvReport, REQUIRED (+8 more)
...
Cohesion: 0.27
Nodes (10): appUrl(), bodySchema, POST(), isPaidPlan(), createZarinPayPayment(), getStoreId(), getToken(), verifyZarinPayPayment() (+2 more)

### Community 148 - "route.ts"
Cohesion: 0.15
Nodes (12): AgentTabItem, AgentTabs(), ICONS, SectionHeader(), durations, EMPTY_FORM, ServiceItem, DialogShell() (+4 more)
...
Cohesion: 0.19
Nodes (20): ConversationThreadPage(), ConversationThread(), ThreadMessage, DeliveryFeedback, OperatorReply(), InboundSource, InboundSourceKind, inboundSourceLabel() (+12 more)
...
Cohesion: 0.19
Nodes (12): Intro(), { handlers, auth, signOut }, isPlatformOwnerPhone(), ExtractedIdentity, extractEnglishName(), extractIdentity(), extractPersianName(), PERSIAN_DIGITS (+4 more)
...
### Community 181 - "format.ts"
Cohesion: 0.14
Nodes (22): GET(), bodySchema, Params, POST(), campaignDeliveryText(), CampaignJobData, processCampaign(), processRecipient() (+14 more)
...
Cohesion: 0.26
Nodes (10): AdminCommercialEvent, AdminCommercialEventKind, adminCommercialSmsPhone(), compact(), formatAmount(), formatPaidAt(), notifyAdminCommercialEvent(), planLabelFa() (+2 more)

### Community 204 - "route.ts"
Cohesion: 0.24
Nodes (6): metadata, COPY, Header(), OnboardingShell(), STEPS, Logo()
...
### Community 215 - "resend"
Cohesion: 0.25
Nodes (7): CHANNEL_LABELS, FailedJobLog, HealthPayload, HealthState, QUEUE_LABELS, Service, STATE_META
...
## Knowledge Gaps
- **1134 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `mini-services/**`, `node_modules/**`, `metadata` (+1129 more)
...
- **Why does `cn()` connect `cn` to `route.ts`, `loader.js`, `captureError`, `webhook.ts`, `session.ts`, `page.tsx`, `activity.ts`, `route.ts`, `commercial-config.ts`, `ippanel.ts`, `route.ts`, `layout.tsx`, `page.tsx`, `popular-posts.tsx`, `material-select.tsx`, `getVerticalPack`, `page.tsx`, `social-links.tsx`, `iphone-preview.tsx`, `helpers.ts`, `route.ts`, `chat-orchestrator.ts`, `service-health-panel.tsx`, `layout.tsx`, `instagram.ts`, `popular-posts.tsx`, `route.ts`, `PageHeader`, `index.ts`, `page.tsx`, `resend`, `auth.ts`, `route.ts`, `route.ts`, `docs-sidebar.tsx`, `media-uploader.tsx`, `vigento-actions.ts`, `page.tsx`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `t()` connect `loader.js` to `automation-manager.tsx`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `embeddings.ts`, `@prisma/client`, `react-dom`, `route.ts`, `model-select.tsx`, `isAdminAuthed`, `index.ts`, `normalizeChatLinkSettings`?**
