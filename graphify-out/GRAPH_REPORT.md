...
## Corpus Check
- 662 files · ~493,299 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3913 nodes · 9108 edges · 251 communities (222 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `339d18ba`
...
Cohesion: 0.11
Nodes (45): AutomationAction, AutomationPolicy, AutomationRow, AutomationTrigger, checkUserFollows(), DEFAULT_AUTOMATION_POLICY, executeAction(), isReplyMode() (+37 more)

### Community 1 - "cn"
Cohesion: 0.14
Nodes (25): bodySchema, Params, POST(), POST(), bodySchema, GET(), Params, POST() (+17 more)

### Community 2 - "ui.tsx"
Cohesion: 0.10
Nodes (29): baseUrl(), bodySchema, Params, POST(), WEBHOOK_PATH, baleAdapter(), getBaleBotInfo(), setBaleWebhook() (+21 more)

### Community 3 - "loader.js"
Cohesion: 0.11
Nodes (45): actionChip(), applyConfig(), applyViewportHeight(), autoGrow(), bubble(), clearIntro(), contrast(), el() (+37 more)

### Community 4 - "prisma.ts"
Cohesion: 0.06
Nodes (38): bodySchema, GET(), ownAgent(), Params, PUT(), DELETE(), ownAgent(), Params (+30 more)

### Community 5 - "chat-engine.ts"
Cohesion: 0.07
Nodes (49): AgentSettingsData, appendSalesGuidance(), buildSystemPrompt(), bumpProductQueries(), generateReply(), GenerateReplyOptions, GenerateReplyResult, hydrateSystemPrompt() (+41 more)
...
Cohesion: 0.08
Nodes (24): AiModelPolicyForm(), formatUSD(), ModelAlias, ModelOption, Notice, Policy, ChannelOption, ConversationFilters() (+16 more)
...
Cohesion: 0.06
Nodes (44): AgentWizard(), BUSINESS_PRESETS, channelLabel(), ConfigDraft, CreatedAgent, draftFromRole(), FormState, NaturalConversationControls() (+36 more)
...
Cohesion: 0.13
Nodes (22): AttentionItem(), buildTrend(), daysAgo(), isRecord(), MODULE_META, OverviewPage(), percentDelta(), PLAN_NAMES_FA (+14 more)
...
Cohesion: 0.22
Nodes (16): appUrl(), connectNumber(), GET(), POST(), buildWhatsappAuthUrl(), exchangeCodeForUserToken(), exchangeForLongLivedToken(), listWhatsappBusinessAccounts() (+8 more)
...
Cohesion: 0.10
Nodes (22): AgentAnalyticsPage(), AnalyticsPage(), daysAgo(), nfFa(), STAGE_LABELS_EN, STAGE_LABELS_FA, ProductsPage(), BarItem (+14 more)

### Community 18 - "activity.ts"
Cohesion: 0.13
Nodes (19): AdminPaymentsPage(), AdminPaymentDetailPage(), GATEWAY_BADGE, PLAN_BADGE, STATUS_BADGE, StatusSummary(), fmtDay(), fmtIRR() (+11 more)

### Community 19 - "registry.ts"
Cohesion: 0.09
Nodes (21): bodySchema, Params, POST(), FacebookPagesResult, IgHost, IgWebhook, instagramAdapter(), InstagramPageOption (+13 more)

### Community 20 - "commercial-config.ts"
Cohesion: 0.07
Nodes (33): AdminPlatformSettingsPage(), GET(), GET(), nonNegativeInt, planSchema, positiveInt, PUT(), schema (+25 more)

### Community 21 - "handler.ts"
Cohesion: 0.11
Nodes (26): getContactName(), persistFixedAssistantReply(), persistInboundOnly(), processChannelInbound(), profileFields(), NOTE: do NOT add sender.id here — that's the customer who messaged, reactAfterInstagramReply(), ResolvedChannel (+18 more)

### Community 22 - "rateLimit"
Cohesion: 0.11
Nodes (20): Progress(), AdminUsagePage(), parseRange(), TYPE_LABEL, OPTIONS, RangeKind, RangeSwitch(), ActivationFunnel() (+12 more)
...
Cohesion: 0.12
Nodes (37): allAgentIds(), assignProduct(), authHeader(), availableCategorySlug(), canonicalize(), categoryExternalId(), categorySlug(), deleteProductFromWoo() (+29 more)
...
Cohesion: 0.15
Nodes (19): generateMetadata(), getWorkspaceId(), Props, PublicBlogPostPage(), PublicPost, TrendSpark(), getPopularPosts(), loadPopularPosts (+11 more)

### Community 32 - "layout.tsx"
Cohesion: 0.07
Nodes (52): AdminAgentDetailPage(), CHANNEL_LABEL, AdminAgentsPage(), AccountStatus(), AdminAiPage(), formatProviderUSD(), formatRequestUSD(), formatRial() (+44 more)
...
Cohesion: 0.12
Nodes (30): GET(), Params, POST(), PUT(), appUrl(), GET(), POST(), checkChannelConnectAllowed() (+22 more)

### Community 35 - "auth.ts"
Cohesion: 0.17
Nodes (20): decrypt(), NotifyParams, notifyWorkspace(), sendOperatorTelegramNotification(), alertSilentChannels(), cleanupOldRecords(), ONBOARDING_NEXT_STEP_FA, remindExpiringSubscriptions() (+12 more)
...
Cohesion: 0.12
Nodes (17): WEBHOOK_PATH, InstagramConnectFlow(), ChannelSettings(), FIELD_SETS, FieldDef, formatRelative(), ICONS, isComplete() (+9 more)
...
Cohesion: 0.08
Nodes (43): POST(), detectUnanswered(), evaluateHandoffPolicy(), formatReason(), HandoffDecision, HandoffPolicyInput, HandoffReasonCode, handoffReplyText() (+35 more)
...
Cohesion: 0.15
Nodes (12): DashboardBarList(), NamedPoint, CommerceTabs(), ProductCard, ProductGrid(), ProductsToolbar(), formatDate(), SyncLogEntry (+4 more)
...
Cohesion: 0.16
Nodes (24): bodySchema, Params, POST(), SummaryJobData, deleteContent(), handleWpContentWebhook(), upsertContent(), WpContentPayload (+16 more)

### Community 44 - "chat-client.tsx"
Cohesion: 0.12
Nodes (16): Avatar(), ChatLinkClient(), errorText(), Intro(), Msg, nextId(), parseAssistant(), ProductCard (+8 more)

### Community 45 - "material-select.tsx"
Cohesion: 0.07
Nodes (35): PLAN_KEY, assurances, metadata, Meter(), ModelSelect(), TIER_ICON, AMOUNTS_IRR, CreditTopup() (+27 more)
...
Cohesion: 0.14
Nodes (28): answerCallback(), appUrl, escapeHtml(), getOpenAlerts(), handleCallback(), healthText(), helpText(), homeText() (+20 more)
...
Cohesion: 0.11
Nodes (21): DELETE(), GET(), getOwnedAgent(), Params, PATCH(), getRoleTemplate(), LEGACY_ROLE_TEMPLATES, detectRole() (+13 more)

### Community 57 - "vertical-bookings-vigento.test.ts"
Cohesion: 0.27
Nodes (6): GET(), MessengerConfig, MessengerSettings, readBotToken(), resolveChannel(), resolveInstagramHost()
...
Cohesion: 0.18
Nodes (14): Params, POST(), encrypt(), getKey(), buildWhatsappOAuthConfig(), WhatsappOAuthConfig, subscribeWabaToWebhook(), isNonEmptyString() (+6 more)
...
Cohesion: 0.19
Nodes (18): formatPersianDate(), generateCode(), IppanelMeta, ippanelSend(), isSmsConfigured(), OtpRateLimitError, planLabelFa(), sendActivationCompleteSms() (+10 more)

### Community 62 - "helpers.ts"
Cohesion: 0.19
Nodes (16): batchSchema, digest(), eventSchema, handleManualSync(), loadManualIntegration(), normalizeSiteUrl(), parseDelivery(), pluginVersionFromHeaders() (+8 more)
...
Cohesion: 0.18
Nodes (18): logout(), BuildMode, Props, Header(), MobileNav(), getDashboardNavForProfile(), getDashboardNavFromModules(), Sidebar() (+10 more)
...
Cohesion: 0.13
Nodes (26): Params, POST(), Params, POST(), PUT(), GET(), Params, POST() (+18 more)

### Community 74 - "instagram.ts"
Cohesion: 0.14
Nodes (33): AdminOverviewPage(), parseRange(), startOfToday(), ClearErrorLogsButton(), SystemErrorsPanel(), getAiOverview(), AgentSpark, conversationsDaily() (+25 more)
...
Cohesion: 0.22
Nodes (14): GET(), Params, buildFallbackSummary(), compact(), ConversationSummaryResult, ensureConversationSummary(), isEmojiOnly(), isGreetingOnly() (+6 more)

### Community 77 - "conversation-thread.tsx"
Cohesion: 0.11
Nodes (28): EditAutomationPage(), InstagramAutomationContent(), normalizeSettings(), EditInstagramAutomationPage(), AutomationCard(), MESSAGE_TYPE_ICON, REPLY_MODE_ICON, TYPE_ICON (+20 more)
...
Cohesion: 0.14
Nodes (18): ChangeDetail, MODULES, VerticalChangeNotice(), BusinessProfileStep(), ICONS, Props, SubStep, CapabilityOptions() (+10 more)

### Community 86 - "page.tsx"
Cohesion: 0.10
Nodes (21): metadata, metadata, MarketingLayout(), SESSION_COOKIE_NAMES, COPY, ScopedIntlProvider(), BackToTop(), COPY (+13 more)
...
Cohesion: 0.27
Nodes (10): DELETE(), Params, PATCH(), settingsSchema, normalizeMessengerSettings(), AutomationPolicySnapshot, InstagramOAuthConfig, readIgUserId() (+2 more)

### Community 89 - "product.ts"
Cohesion: 0.42
Nodes (10): BlogEditor(), isFa(), analyzeSeo(), deriveExcerpt(), deriveSeoDescription(), extractKeywords(), SeoAnalysis, STOP_WORDS_EN (+2 more)
...
Cohesion: 0.24
Nodes (10): BrandHeader(), NAV_ITEMS, NavItem, NavList(), AdminLayout(), metadata, MobileNavTrigger(), adminLogout() (+2 more)

### Community 95 - "page-header.tsx"
Cohesion: 0.22
Nodes (3): Props, ADMIN_VISIBLE_RELATED_WHERE, globalForPrisma
...
Cohesion: 0.11
Nodes (22): POST(), GET(), POST(), POST(), POST(), POST(), GET(), POST() (+14 more)

### Community 108 - "automation-card.tsx"
Cohesion: 0.29
Nodes (8): GET(), LiveResource, ContactsPage(), contactLiveVersion(), ContactSnapshot, conversationLiveVersion(), ConversationSnapshot, VersionRow
...
Cohesion: 0.16
Nodes (16): bodySchema, GET(), ownAgent(), Params, POST(), OPTIONS(), GET(), OPTIONS() (+8 more)
...
Cohesion: 0.11
Nodes (19): AgentCatalogPage(), NewAutomationPage(), AgentLearningPage(), NewInstagramAutomationPage(), InstagramWorkspacePage(), CategoriesPage(), NewProductPage(), LearningCenter() (+11 more)

### Community 122 - "formatDateTime"
Cohesion: 0.15
Nodes (16): confirmSchema, Params, POST(), DELETE(), Params, PATCH(), GET(), POST() (+8 more)

### Community 123 - "page.tsx"
Cohesion: 0.06
Nodes (43): ContactDetailPage(), CHANNEL_LABELS_FA, ConversationsPage(), SalesFilter, VALID_CHANNELS, VALID_SALES_FILTERS, VALID_STATUSES, CampaignComposer() (+35 more)

### Community 125 - "normalizeChatLinkSettings"
Cohesion: 0.14
Nodes (20): DELETE(), GET(), ownAgent(), Params, PUT(), putSchema, GET(), Params (+12 more)
...
Cohesion: 0.12
Nodes (26): crawlUrlToKnowledge(), refreshStaleUrlKnowledge(), ChunkOptions, chunkText(), splitBySentence(), contextualChunk(), IngestionJobData, processIngestion() (+18 more)
...
Cohesion: 0.47
Nodes (5): generateMetadata(), getWorkspaceId(), Props, PublicBlogCategoryPage(), PublicPostCard()

### Community 147 - "route.ts"
Cohesion: 0.06
Nodes (50): POST(), appUrl(), GET(), handleCallback(), POST(), readPid(), appUrl(), bodySchema (+42 more)

### Community 148 - "route.ts"
Cohesion: 0.06
Nodes (34): AdminDatabasePage(), Message, Proposal, QUICK_PROMPTS, VigentoAdminConsole(), WELCOME, Msg, TestPlayground() (+26 more)
...
### Community 164 - "wp-content.ts"
Cohesion: 0.23
Nodes (8): POST(), { handlers, auth, signOut }, isPlatformOwnerPhone(), normalizePhone(), allowOtpVerificationAttempt(), isOTPValid(), verifyOTP(), mocks

### Community 165 - "route.ts"
Cohesion: 0.18
...
Cohesion: 0.20
Nodes (15): ExtractedIdentity, extractEnglishName(), extractIdentity(), extractPersianName(), buildOrderContext(), extractOrderId(), FA_STATUS, formatDate() (+7 more)
...
Cohesion: 0.67
Nodes (3): WhatsAppQrConnect(), qrcode, qrcode
...
Cohesion: 0.09
Nodes (25): CHANNEL_LABEL, STATUS_META, GATEWAY_BADGE, PLAN_BADGE, STATUS_BADGE, AdminPagination(), BADGE_TONES, BadgeTone (+17 more)
...
Cohesion: 0.23
Nodes (12): AdminCommercialEvent, AdminCommercialEventKind, adminCommercialSmsPhone(), captureAdminCommercialSmsError(), compact(), formatAmount(), formatPaidAt(), gatewayLabelFa() (+4 more)
...
Cohesion: 0.24
Nodes (8): LoginPage(), metadata, PAID_PLANS, BillingPage(), EASE, OTPCredentialLike, PhoneOtpForm(), Step
...
Cohesion: 0.14
Nodes (13): PageHeader(), fmtBytes(), Metrics, Sample, ServerStatsWidget(), CHANNEL_LABELS, FailedJobLog, HealthPayload (+5 more)
...
Cohesion: 0.17
Nodes (14): ConversationThreadPage(), ConversationActions(), Status, ConversationPanel(), HandoffAlertProp, MESSENGER_META, ConversationThread(), ThreadMessage (+6 more)
...
Cohesion: 0.19
Nodes (15): AdminRevenuePage(), PLAN_BADGE, calculateFinanceSummary(), FinanceInputs, FinanceSummary, parseUsdToIrrRate(), safeNonNegative(), getFinanceSummary() (+7 more)

### Community 244 - "customer-identification.ts"
Cohesion: 0.33
Nodes (5): VigentoPage(), CAPABILITIES, ChatMessage, Locale, VigentoWorkspace()

## Knowledge Gaps
- **1192 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `mini-services/**`, `node_modules/**`, `metadata` (+1187 more)
...
- **Why does `cn()` connect `route.ts` to `charts.ts`, `models.ts`, `captureError`, `session.ts`, `page.tsx`, `activity.ts`, `commercial-config.ts`, `rateLimit`, `layout.tsx`, `route.ts`, `popular-posts.tsx`, `trend-chart.tsx`, `material-select.tsx`, `getVerticalPack`, `page.tsx`, `route.ts`, `social-links.tsx`, `iphone-preview.tsx`, `route.ts`, `chat-orchestrator.ts`, `page.tsx`, `PageHeader`, `page.tsx`, `conversation-thread.tsx`, `checkWorkspaceActive`, `wp-content.ts`, `index.ts`, `page.tsx`, `route.ts`, `react-dom`, `page.tsx`, `automation-card.tsx`, `page.tsx`, `route.ts`, `vigento-actions.ts`, `page.tsx`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `@ricky0123/vad-web`, `tailwind-merge`, `route.ts`, `@prisma/client`, `route.ts`, `model-select.tsx`, `isAdminAuthed`, `index.ts`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `getCurrentUser()` connect `prisma.ts` to `cn`, `ui.tsx`, `page-header.tsx`, `campaign-composer.tsx`, `page.tsx`, `registry.ts`, `route.ts`, `automation-form.tsx`, `registry.ts`, `route.ts`, `route.ts`, `jobs.ts`, `getVerticalPack`, `config.ts`, `layout.tsx`, `low-credit-alert.ts`, `appointments-workspace.tsx`, `helpers.ts`, `service-health-panel.tsx`, `automation-manager.tsx`, `charts.ts`, `booking-manager.tsx`, `page.tsx`, `automation-manager.tsx`, `scheduler.ts`, `auth.ts`, `route.ts`, `route.ts`, `stt.ts`, `session-revalidation.test.ts`, `logo.tsx`, `material-select.tsx`, `service.ts`, `route.ts`, `automation-card.tsx`, `media-uploader.tsx`, `page.tsx`, `route.ts`, `vigento-actions.ts`, `formatDateTime`, `normalizeChatLinkSettings`?**
