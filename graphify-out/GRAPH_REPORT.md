...
## Corpus Check
- 719 files · ~540,196 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4271 nodes · 9995 edges · 277 communities (249 shown, 28 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 100 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b2c27ddb`
...
## Communities (277 total, 28 thin omitted)

### Community 0 - "automation.ts"
Cohesion: 0.10
Nodes (50): ChatAgent, AutomationAction, AutomationContext, AutomationPolicy, AutomationRow, AutomationTrigger, checkUserFollows(), commentDmTarget() (+42 more)
...
### Community 2 - "ui.tsx"
Cohesion: 0.13
Nodes (18): appBaseUrl(), createSchema, encryptSensitiveFields(), GET(), normalizeWooStoreUrl(), POST(), SENSITIVE_FIELDS, MessengerConfig (+10 more)
...
Cohesion: 0.09
Nodes (25): AgentKnowledgePage(), agent_hint_body(), agent_hint_title(), AgentsPage(), InstagramWorkspacePage(), DigitalMenuDashboardPage(), CategoriesPage(), NewProductPage() (+17 more)

### Community 5 - "chat-engine.ts"
Cohesion: 0.11
Nodes (36): Params, POST(), appUrl(), connectNumber(), GET(), POST(), checkChannelConnectAllowed(), consumeOAuthState() (+28 more)

### Community 6 - "qr-config.ts"
Cohesion: 0.19
Nodes (23): AvailabilityRuleLike, AvailabilityWindow, AvailableSlot, buildAvailableSlots(), BusyAppointmentLike, DateExceptionLike, effectiveAvailabilityWindows(), inspectRequestedSlot() (+15 more)
...
Cohesion: 0.23
Nodes (11): EditAutomationPage(), InstagramAutomationContent(), normalizeSettings(), EditInstagramAutomationPage(), Automation, AutomationAction, AutomationTrigger, DEFAULT_SETTINGS (+3 more)

### Community 9 - "prompt-builder.ts"
Cohesion: 0.12
Nodes (23): BaseRoleKey, booleanOrDefault(), buildLayeredPrompt(), BUSINESS_ROLE_SPECS, BUSINESS_ROLE_TEMPLATES, BusinessRoleSpec, BusinessType, DEFAULT_CONVERSATION_CONFIG (+15 more)
...
Cohesion: 0.20
Nodes (12): AdminAgentsPage(), AdminBlogPage(), EmptyState(), fa(), FilterPills(), LevelBadge(), StatCard(), ClearErrorLogsButton() (+4 more)
...
Cohesion: 0.21
Nodes (16): buildTrend(), daysAgo(), isRecord(), MODULE_META, OverviewPage(), percentDelta(), PLAN_NAMES_FA, channelAvatarFor() (+8 more)

### Community 15 - "syncOnboarding"
Cohesion: 0.07
Nodes (30): GET(), bodySchema, Params, POST(), FacebookPagesResult, IgHost, IgWebhook, instagramAdapter() (+22 more)
...
Cohesion: 0.10
Nodes (20): asJson(), claimInboundEvent(), ClaimInboundEventInput, ClaimInboundEventResult, InboundEventEffects, InboundEventLease, InboundEventLeaseBusyError, InboundEventLeaseGuard (+12 more)
...
Cohesion: 0.09
Nodes (31): assurances, metadata, PLAN_FA_NAMES, PRICING_FAQ, PricingPage(), ReplyCreditEstimator(), MobilePlanView, PLAN_TRANSLATION_KEY (+23 more)
...
Cohesion: 0.08
Nodes (39): POST(), entryOwnerIds(), getContactName(), handleInbound(), handleInstagramGlobalInbound(), IgWebhookEntry, markAssistantDelivery(), persistFixedAssistantReply() (+31 more)
...
Cohesion: 0.19
Nodes (17): buildLexicalQuery(), LEXICAL_STOPWORDS, normalizePersian(), isCurated(), RankableChunk, rankRetrievedChunks(), deleteChunksForProduct(), insertChunk() (+9 more)

### Community 24 - "automation-form.tsx"
Cohesion: 0.08
Nodes (50): sweepAdminCommercialSmsOutbox(), sendPurchaseConfirmation(), captureError(), refreshLongLivedToken(), notifyWorkspace(), getRedis(), globalForRedis, AdminCreditTopupPatternData (+42 more)
...
Cohesion: 0.10
Nodes (41): handleManualSync(), loadManualIntegration(), allAgentIds(), assignProduct(), authHeader(), availableCategorySlug(), canonicalize(), categoryExternalId() (+33 more)

### Community 28 - "config.ts"
Cohesion: 0.15
Nodes (16): COLOR_PRESETS, WebWidgetChannel(), WIDGET_ICON_COMPONENTS, DEFAULT_WIDGET_SETTINGS, hostnameOf(), isOriginAllowed(), normalizeDomains(), normalizeWidgetSettings() (+8 more)
...
Cohesion: 0.13
Nodes (22): AdminPaymentsPage(), AdminPaymentDetailPage(), GATEWAY_BADGE, PLAN_BADGE, STATUS_BADGE, StatusSummary(), BADGE_TONES, BadgeTone (+14 more)
...
Cohesion: 0.16
Nodes (21): ConversationThread(), ThreadMessage, DeliveryFeedback, OperatorReply(), InboundSource, InboundSourceKind, inboundSourceLabel(), readInboundSource() (+13 more)

### Community 35 - "auth.ts"
Cohesion: 0.09
Nodes (12): defaultReplyMode(), emptyTextMessage(), KeywordFilter, MediaUploader, normalizeMessage(), PostFilter, ProductLite, toFormState() (+4 more)

### Community 36 - "oauth.ts"
Cohesion: 0.13
Nodes (4): reactAfterInstagramReply(), ResolvedChannel, MessengerAdapter, mocks

### Community 37 - "page.tsx"
Cohesion: 0.09
Nodes (31): AdminCommercialEvent, AdminCommercialEventKind, adminCommercialSmsPhone(), captureAdminCommercialSmsError(), compact(), formatAmount(), gatewayLabelFa(), notifyAdminCommercialEvent() (+23 more)
...
Cohesion: 0.13
Nodes (27): analyzeSalesConversation(), clamp(), countConsecutiveUnanswered(), detectRepeatedRequest(), excerpt(), firstMatch(), GENERAL_RISK_TERMS, includesTerm() (+19 more)
...
Cohesion: 0.13
Nodes (31): allClaimedInstagramIds(), GET(), Params, POST(), PUT(), appUrl(), GET(), POST() (+23 more)

### Community 43 - "jobs.ts"
Cohesion: 0.13
Nodes (26): bodySchema, GET(), ownAgent(), Params, PUT(), deleteContent(), handleWpContentWebhook(), upsertContent() (+18 more)

### Community 44 - "chat-client.tsx"
Cohesion: 0.07
Nodes (31): defaultSettings(), GET(), Params, PATCH(), patchSchema, REPLY_POLICIES, GET(), ownAgent() (+23 more)

### Community 45 - "material-select.tsx"
Cohesion: 0.14
Nodes (15): generateMetadata(), PAGE_COPY, SITE_URL, SOLUTION_META, SOLUTION_META_EN, SolutionPage(), Spotlight(), SOLUTIONS_EN (+7 more)

### Community 46 - "getVerticalPack"
Cohesion: 0.15
Nodes (22): Params, POST(), Params, POST(), PUT(), GET(), Params, GET() (+14 more)

### Community 47 - "vigent-woo.php"
Cohesion: 0.16
Nodes (18): onRequestError(), register(), captureDebug(), captureInfo(), captureLog(), captureWarning(), emitConsole(), errorDetails() (+10 more)
...
Cohesion: 0.36
Nodes (12): generateMetadata(), BlogEditor(), isFa(), analyzeSeo(), deriveExcerpt(), deriveSeoDescription(), deriveSeoTitle(), extractKeywords() (+4 more)

### Community 51 - "page.tsx"
Cohesion: 0.20
Nodes (9): COPY, MarketingMobileMenu(), COPY, Navbar(), SECTION_IDS, OnboardingShell(), STEPS, LanguageSwitcher() (+1 more)

### Community 52 - "social-links.tsx"
Cohesion: 0.07
Nodes (16): CHANNEL_ICONS, COPY, MobileChannelExplorer(), MobileChannelTab, COPY, Pillar, COPY, Footer() (+8 more)
...
Cohesion: 0.06
Nodes (43): GET(), BodySchema, POST(), GET(), POST(), schema, agentStateSchema, creditSchema (+35 more)

### Community 56 - "low-credit-alert.ts"
Cohesion: 0.14
Nodes (26): GET(), PUT(), schema, POST(), recordRun(), requestSchema, inputSchema, POST() (+18 more)

### Community 57 - "vertical-bookings-vigento.test.ts"
Cohesion: 0.08
Nodes (25): BrandHeader(), NAV_ITEMS, NavItem, NavList(), AdminLayout(), metadata, MobileNavTrigger(), adminLogout() (+17 more)
...
Cohesion: 0.13
Nodes (15): DELETE(), GET(), getOwnedAgent(), Params, PATCH(), GET(), POST(), hasCompleteCustomerIdentity() (+7 more)
...
Cohesion: 0.11
Nodes (23): bookingErrorResponse(), GET(), POST(), GET(), POST(), GET(), AppointmentsPage(), BookingError (+15 more)

### Community 62 - "helpers.ts"
Cohesion: 0.17
Nodes (16): detectUnanswered(), evaluateHandoffPolicy(), formatReason(), HandoffDecision, HandoffPolicyInput, HandoffReasonCode, handoffThreshold(), REQUIRED_HANDOFF_REASONS (+8 more)

### Community 63 - "page.tsx"
Cohesion: 0.08
Nodes (20): ChannelsSection, FaqSection, FeaturesSection, HOME_METADATA_COPY, LivePlatformStats(), PricingSection, SITE_URL, STRUCTURED_DATA_COPY (+12 more)
...
Cohesion: 0.35
Nodes (12): appHeaders(), asRecord(), chatCompletion(), ChatOptions, ChatToolCall, DEFAULT_MAX_PRICE, firstChoice(), maxPriceFor() (+4 more)

### Community 67 - "chat-orchestrator.ts"
Cohesion: 0.15
Nodes (22): bodySchema, Params, POST(), campaignDeliveryText(), CampaignJobData, processCampaign(), processRecipient(), SEND_INTERVAL_MS (+14 more)
...
Cohesion: 0.15
Nodes (32): AdminOverviewPage(), parseRange(), startOfToday(), SystemErrorsPanel(), getAiOverview(), AgentSpark, conversationsDaily(), conversationsDailyByAgent() (+24 more)
...
Cohesion: 0.13
Nodes (23): bodySchema, Params, POST(), POST(), POST(), bodySchema, POST(), GET() (+15 more)

### Community 77 - "conversation-thread.tsx"
Cohesion: 0.11
Nodes (29): ALLOWED, EXTENSION, POST(), DELETE(), Params, GET(), ownAgent(), Params (+21 more)
...
Cohesion: 0.19
Nodes (10): CHANNELS, IntegrationsPage(), formatWooSyncResult(), SyncFeedback, WooSyncResult, entityLabel(), IntegrationCard(), StoreIntegrationItem (+2 more)

### Community 80 - "scheduler.ts"
Cohesion: 0.11
Nodes (20): isOrderStatus(), ORDER_STATUSES, OrdersPage(), OrderStatus, shortStoreUrl(), STATUS_TRANSLATION_KEYS, statusClassName(), ProductsPage() (+12 more)
...
Cohesion: 0.16
Nodes (13): createQueueConnection(), QUEUE_NAMES, worker, campaignWorker, connection, inboundWorker, ingestionWorker, notificationWorker (+5 more)

### Community 83 - "checkWorkspaceActive"
Cohesion: 0.13
Nodes (22): GET(), PATCH(), Props, ChatTool, ChatUsage, BOOKING_AGENT_TOOLS, BOOKING_TOOL_SYSTEM_INSTRUCTION, cancelSchema (+14 more)
...
Cohesion: 0.10
Nodes (23): Message, Proposal, QUICK_PROMPTS, VigentoAdminConsole(), WELCOME, Msg, TestPlayground(), VoiceRecorder (+15 more)
...
Cohesion: 0.22
Nodes (7): BUSINESS_ICONS, BusinessScene, COPY, Hero(), HeroCopy, Locale, NeuralOperationGraph()
...
Cohesion: 0.13
Nodes (19): MessageBuilder(), BaileysInboundKey, phoneDigits(), resolveBaileysInboundIdentity(), ResolvedInboundIdentity, app, AUTH_ROOT, authed() (+11 more)
...
Cohesion: 0.18
Nodes (15): EditProductPage(), AgentSparkline(), SocialProof(), key(), Env, ProductionEnvReport, REQUIRED, requireGroup() (+7 more)

### Community 108 - "automation-card.tsx"
Cohesion: 0.21
Nodes (14): AdminRevenuePage(), PLAN_BADGE, calculateFinanceSummary(), FinanceInputs, FinanceSummary, parseUsdToIrrRate(), safeNonNegative(), getFinanceSummary() (+6 more)
...
Cohesion: 0.15
Nodes (18): DELETE(), Params, settingsSchema, avatarResponse(), GET(), Params, unavailable(), ALLOWED_IMAGE_TYPES (+10 more)
...
Cohesion: 0.15
Nodes (18): DocsHomePage(), metadata, DocPageRoute(), generateMetadata(), Props, PublicMenuPage(), DocContent(), pick() (+10 more)
...
Cohesion: 0.22
Nodes (13): GET(), PATCH(), AgentLayout(), DashboardLayout(), metadata, AgentTabItem, AgentTabs(), ICONS (+5 more)
...
Cohesion: 0.16
Nodes (11): AutomationCard(), MESSAGE_TYPE_ICON, REPLY_MODE_ICON, TYPE_ICON, ChannelSettingsCard(), InstagramAutomationManager(), TABS, MessageType (+3 more)

### Community 122 - "readBotToken"
Cohesion: 0.18
Nodes (15): bodySchema, GET(), ownAgent(), Params, POST(), DELETE(), ownAgent(), Params (+7 more)

### Community 123 - "page.tsx"
Cohesion: 0.08
Nodes (37): ContactDetailPage(), ConversationThreadPage(), CHANNEL_LABELS_FA, ConversationsPage(), SalesFilter, VALID_CHANNELS, VALID_SALES_FILTERS, VALID_STATUSES (+29 more)

### Community 125 - "normalizeChatLinkSettings"
Cohesion: 0.38
Nodes (5): getOnboardingProgress(), OnboardingProgressSignals, OnboardingProgressStageKey, SETUP_STAGES, emptySignals
...
Cohesion: 0.18
Nodes (12): parseProductShowcaseContent(), productTokenBounds(), formatCount(), INITIAL_SCROLL, ProductShowcaseRail(), ScrollState, ShowcaseCard(), readProduct() (+4 more)
...
Cohesion: 0.09
Nodes (23): bodySchema, faqText(), normalize(), Params, POST(), redispatchExisting(), DELETE(), dismissSchema (+15 more)
...
Cohesion: 0.14
Nodes (13): AgentWizard(), BUSINESS_PRESETS, channelLabel(), ConfigDraft, CreatedAgent, draftFromRole(), FormState, VigentoComposer() (+5 more)
...
Cohesion: 0.21
Nodes (11): AgentSettingsForm(), getRoleTemplate(), LEGACY_ROLE_TEMPLATES, detectRole(), fallbackVigentoDraft(), recommendedChannels, roleKeys, VigentoDraft (+3 more)
...
Cohesion: 0.13
Nodes (24): baseUrl(), bodySchema, Params, POST(), WEBHOOK_PATH, baleAdapter(), getBaleBotInfo(), setBaleWebhook() (+16 more)
...
Cohesion: 0.26
Nodes (16): LocalizedDatePicker(), PickerPosition, WEEKDAYS, formatDate(), asDate(), CalendarMonth, calendarMonthLength(), calendarMonthOffset() (+8 more)
...
Cohesion: 0.08
Nodes (32): AdminAgentDetailPage(), CHANNEL_LABEL, AdminConversationDetailPage(), CHANNEL_LABEL, STATUS_LABEL, AdminConversationsPage(), CHANNEL_LABEL, STATUS_META (+24 more)
...
Cohesion: 0.13
Nodes (19): confirmSchema, Params, POST(), DELETE(), Params, PATCH(), GET(), POST() (+11 more)
...
Cohesion: 0.16
Nodes (11): NaturalConversationControls(), ContactDetailEditor(), Stage, STAGE_KEY, STAGES, CategoryNode, CategoryTree(), MaterialSelect() (+3 more)
...
Cohesion: 0.10
Nodes (28): GET(), adminLogin(), AdminLoginState, AdminLoginForm(), initial, AdminLoginPage(), metadata, DELETE() (+20 more)
...
Cohesion: 0.23
Nodes (12): StartChatParams, ASSISTANT_OFFER_RE, explicitRequestedCount(), extractProductTerms(), fetchCatalogProducts(), historyForProductTurn(), normalizePersianText(), planProductRequest() (+4 more)
...
Cohesion: 0.08
Nodes (38): PATCH(), DELETE(), GET(), ownAgent(), Params, PUT(), putSchema, GET() (+30 more)
...
Cohesion: 0.04
Nodes (47): AgentCatalogPage(), AttentionItem(), fmtBytes(), Metrics, Sample, ServerStatsWidget(), AccessKey, AccessRow() (+39 more)
...
Cohesion: 0.14
Nodes (8): AgentSettingsData, EMPTY_CONFIG, LayerTab, NormalizedPromptConfig, PromptConfig, PromptFormatConfig, PromptQAPair, RoleTemplate

### Community 238 - "route.ts"
Cohesion: 0.36
Nodes (9): logout(), MobileNav(), getDashboardNavForProfile(), getDashboardNavFromModules(), Sidebar(), collapseDashboardNavigationModules(), DashboardModuleKey, getDashboardModuleLabel() (+1 more)

### Community 239 - "woo-connect-wizard.tsx"
Cohesion: 0.24
Nodes (12): batchSchema, digest(), eventSchema, normalizeSiteUrl(), parseDelivery(), pluginVersionFromHeaders(), POST(), sameSiteUrl() (+4 more)

### Community 240 - "route.ts"
Cohesion: 0.23
Nodes (16): ProductDetailPage(), ProductShowcase, AttrRow, extractListItems(), formatAttrValue(), normalizeAttributes(), stripListBlocks(), buildTrustedProductReply() (+8 more)
...
Cohesion: 0.16
Nodes (15): Props, Props, PublicBlogPostPage(), PublicPost, PublicPostCard(), TrendSpark(), getPopularPosts(), loadPopularPosts (+7 more)

### Community 243 - "neural-network-primitives.tsx"
Cohesion: 0.25
Nodes (7): Button, buttonClasses(), ButtonProps, ButtonSize, ButtonVariant, SIZES, VARIANTS

### Community 244 - "auth.config.ts"
Cohesion: 0.50
Nodes (4): FormState, GateMode, MatchMode, StoryScope
...
Cohesion: 0.24
Nodes (10): buildOperatorAlertKeyboard(), buildOperatorMenuKeyboard(), normalizeAppUrl(), OperatorBotCallback, operatorWebhookSecret(), parseOperatorBotCallback(), TelegramInlineKeyboardButton, TelegramInlineKeyboardMarkup (+2 more)
...
### Community 259 - "session-revalidation.test.ts"
Cohesion: 0.22
...
Cohesion: 0.22
Nodes (6): KbItem, KbStatus, Mode, asDate(), DIVISIONS, NOTE: values that flow through Next.js `unstable_cache` (or cross the

### Community 263 - "customer-identification.ts"
Cohesion: 0.50
Nodes (6): ExtractedIdentity, extractEnglishName(), extractIdentity(), extractPersianName(), looksLikePersonName(), NAME_STOPWORDS

### Community 264 - "rag.ts"
Cohesion: 0.33
Nodes (8): buildCatalogBlock(), buildServiceBlock(), CatalogProduct, CatalogService, formatPrice(), RagContext, sanitizeUntrusted(), RetrievedChunk

### Community 265 - "ai-model-policy-form.tsx"
Cohesion: 0.29
...
### Community 270 - "widget-preview.tsx"
Cohesion: 0.53
Nodes (5): FONT_FAMILY_BY_KEY, hexToRgba(), shade(), WidgetPreview(), resolveCornerRadii()

### Community 271 - "route.ts"
Cohesion: 0.60
Nodes (3): POST(), backfillWorkspaceSalesInsights(), mocks
...
Cohesion: 0.06
Nodes (41): metadata, OnboardingPage(), AgentBuilderEntry(), BuildMode, Props, Header(), ChangeDetail, MODULES (+33 more)

### Community 275 - "zarinpay.ts"
Cohesion: 0.13
Nodes (24): POST(), appUrl(), GET(), handleCallback(), POST(), readPid(), appUrl(), bodySchema (+16 more)

## Knowledge Gaps
- **1312 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `mini-services/**`, `node_modules/**`, `metadata` (+1307 more)
...
- **Why does `cn()` connect `react-dom` to `session-revalidation.test.ts`, `prisma.ts`, `page-header.tsx`, `format.ts`, `route.ts`, `ai-model-policy-form.tsx`, `models.ts`, `page.tsx`, `woo-connect-wizard.tsx`, `registry.ts`, `commercial-config.ts`, `rateLimit`, `route.ts`, `layout.tsx`, `registry.ts`, `trend-chart.tsx`, `page.tsx`, `route.ts`, `social-links.tsx`, `vertical-bookings-vigento.test.ts`, `iphone-preview.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `charts.ts`, `customer-identification.ts`, `route.ts`, `automation-manager.tsx`, `scheduler.ts`, `model-select.tsx`, `page.tsx`, `validation.ts`, `wp-content.ts`, `logo.tsx`, `route.ts`, `neural-network-primitives.tsx`, `route.ts`, `page.tsx`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `getCurrentUser()` connect `chat-client.tsx` to `route.ts`, `ui.tsx`, `route.ts`, `chat-engine.ts`, `embeddings.ts`, `campaign-composer.tsx`, `prisma.ts`, `route.ts`, `syncOnboarding`, `route.ts`, `activity.ts`, `zarinpay.ts`, `commercial-config.ts`, `handler.ts`, `woocommerce.ts`, `route.ts`, `jobs.ts`, `getVerticalPack`, `layout.tsx`, `low-credit-alert.ts`, `appointments-workspace.tsx`, `types.ts`, `global-error.tsx`, `chat-orchestrator.ts`, `PageHeader`, `page.tsx`, `conversation-thread.tsx`, `dispatchProductEmbed`, `checkWorkspaceActive`, `wp-content.ts`, `service.ts`, `route.ts`, `media-uploader.tsx`, `woo-connect-wizard.tsx`, `route.ts`, `route.ts`, `route.ts`, `readBotToken`, `admin-broadcast-form.tsx`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `intelligence-core-lazy.tsx`, `recharts`, `wp-content.ts`, `@prisma/client`, `webhook-debug.ts`, `next-intl`, `isAdminAuthed`, `index.ts`?**
