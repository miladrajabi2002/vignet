...
## Summary
- 3866 nodes · 8902 edges · 251 communities (224 shown, 27 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 80 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0d285bcc`
...
Cohesion: 0.08
Nodes (52): ProductDetailPage(), AutomationAction, AutomationPolicy, AutomationRow, AutomationTrigger, checkUserFollows(), DEFAULT_AUTOMATION_POLICY, executeAction() (+44 more)

### Community 1 - "cn"
Cohesion: 0.10
Nodes (31): adminLogin(), AdminLoginState, adminLogout(), REASON_MESSAGES_FA, AdminLoginForm(), initial, POST(), bodySchema (+23 more)
...
Cohesion: 0.07
Nodes (34): DELETE(), ownAgent(), Params, POST(), feedbackSchema, Params, POST(), bodySchema (+26 more)

### Community 5 - "chat-engine.ts"
Cohesion: 0.13
Nodes (28): appendSalesGuidance(), buildSystemPrompt(), bumpProductQueries(), generateReply(), GenerateReplyOptions, GenerateReplyResult, hydrateSystemPrompt(), persistAssistantTurn() (+20 more)

### Community 6 - "qr-config.ts"
Cohesion: 0.27
Nodes (8): ScopedIntlProvider(), ADMIN_CLIENT_MESSAGE_PATHS, AUTH_CLIENT_MESSAGE_PATHS, ClientMessageCatalog, DASHBOARD_CLIENT_MESSAGE_PATHS, MARKETING_CLIENT_MESSAGE_PATHS, pickClientMessages(), DASHBOARD_COMPONENT_PREFIXES
...
Cohesion: 0.08
Nodes (37): NaturalConversationControls(), VigentoComposer(), AgentSettingsForm(), EMPTY_CONFIG, LayerTab, BaseRoleKey, booleanOrDefault(), buildLayeredPrompt() (+29 more)
...
Cohesion: 0.11
Nodes (28): AdminAgentDetailPage(), CHANNEL_LABEL, AdminAgentsPage(), AdminBlogPage(), AdminConversationDetailPage(), CHANNEL_LABEL, STATUS_LABEL, AdminDatabasePage() (+20 more)

### Community 13 - "webhook.ts"
Cohesion: 0.05
Nodes (40): آیا اطلاعات مشتری هم ارسال می‌شود؟, آیا با HPOS سازگار است؟, آیا بدون ووکامرس هم کار می‌کند؟, آیا داده‌های حساس ذخیره می‌شوند؟, آیا نیاز به REST API ووکامرس داریم؟, امکانات کلیدی نسخهٔ ۲.۰.۰, تب تنظیمات, تب راهنما (+32 more)

### Community 14 - "page.tsx"
Cohesion: 0.13
Nodes (28): DELETE(), Params, settingsSchema, GET(), Params, POST(), PUT(), appUrl() (+20 more)

### Community 15 - "syncOnboarding"
Cohesion: 0.10
Nodes (27): EditAutomationPage(), NewAutomationPage(), InstagramAutomationContent(), normalizeSettings(), EditInstagramAutomationPage(), NewInstagramAutomationPage(), InstagramWorkspacePage(), AutomationCard() (+19 more)

### Community 16 - "session.ts"
Cohesion: 0.08
Nodes (29): metadata, OnboardingPage(), ChangeDetail, MODULES, VerticalChangeNotice(), BusinessProfileStep(), ICONS, SubStep (+21 more)
...
Cohesion: 0.13
Nodes (18): AdminPaymentsPage(), AdminPaymentDetailPage(), GATEWAY_BADGE, PLAN_BADGE, STATUS_BADGE, StatusSummary(), fmtDay(), fmtIRR() (+10 more)

### Community 19 - "registry.ts"
Cohesion: 0.13
Nodes (16): GET(), bodySchema, Params, POST(), FacebookPagesResult, IgHost, IgWebhook, instagramAdapter() (+8 more)
...
Cohesion: 0.09
Nodes (39): PATCH(), bodySchema, Params, POST(), normalizeMessengerSettings(), readBotToken(), getContactName(), handleInbound() (+31 more)
...
Cohesion: 0.09
Nodes (20): AiModelPolicyForm(), formatUSD(), ModelAlias, ModelOption, Notice, Policy, ContactDeleteAction(), ContactDetailEditor() (+12 more)
...
Cohesion: 0.15
Nodes (28): handleManualSync(), loadIntegration(), POST(), authHeader(), deleteProductFromWoo(), fetchWooJson(), findContactByEmail(), findContactByPhone() (+20 more)
...
Cohesion: 0.20
Nodes (18): appUrl(), connectNumber(), GET(), POST(), buildWhatsappAuthUrl(), exchangeCodeForUserToken(), exchangeForLongLivedToken(), listWhatsappBusinessAccounts() (+10 more)
...
Cohesion: 0.23
Nodes (12): POST(), OAuthState, signState(), stateSecret(), consumeOAuthState(), createOAuthState(), OAuthProvider, OAuthStateBinding (+4 more)
...
Cohesion: 0.12
Nodes (17): AgentDetailPage(), AgentGrowthPanel(), AgentSetupPanel(), CHANNEL_META, ConnectionSummary, GrowthAction, safeHostname(), SetupStep (+9 more)
...
Cohesion: 0.19
Nodes (18): BodySchema, POST(), bodySchema, Params, POST(), createQueueConnection(), isQueueDisabled(), QUEUE_NAMES (+10 more)
...
Cohesion: 0.13
Nodes (27): Meter(), ModelSelect(), TIER_ICON, ReplyCreditEstimator(), OpenRouterManagedModel, AGENT_MODELS, AgentModel, BY_ALIAS (+19 more)

### Community 46 - "getVerticalPack"
Cohesion: 0.13
Nodes (21): GET(), POST(), GET(), PATCH(), GET(), POST(), DashboardLayout(), metadata (+13 more)
...
Cohesion: 0.24
Nodes (10): AdminRevenuePage(), PLAN_BADGE, Th(), getFinanceSummary(), getPlanRevenue(), getTopWorkspacesByRevenue(), PlanRevenueRow, RevenueKPIs (+2 more)
...
Cohesion: 0.12
Nodes (34): notifyWorkspace(), getRedis(), globalForRedis, formatPersianDate(), IppanelMeta, ippanelSend(), isSmsConfigured(), planLabelFa() (+26 more)
...
Cohesion: 0.18
Nodes (11): MessengerConfig, MessengerSettings, newWebhookToken(), decrypt(), encrypt(), getKey(), buildInstagramOAuthConfig(), NotifyParams (+3 more)
...
Cohesion: 0.08
Nodes (20): ChannelsSection, FaqSection, FeaturesSection, HOME_METADATA_COPY, LivePlatformStats(), PricingSection, STRUCTURED_DATA_COPY, VigentoSection (+12 more)
...
Cohesion: 0.21
Nodes (17): logout(), MobileNav(), getDashboardNavForProfile(), getDashboardNavFromModules(), Sidebar(), Props, BUSINESS_SERVICE_OPTIONS, BusinessTypeValue (+9 more)
...
Cohesion: 0.15
Nodes (22): ALLOWED, EXTENSION, POST(), DELETE(), Params, GET(), ownAgent(), Params (+14 more)

### Community 72 - "charts.ts"
Cohesion: 0.17
Nodes (16): confirmSchema, Params, POST(), POST(), createSchema, GET(), POST(), checkWorkspaceActive() (+8 more)
...
Cohesion: 0.11
Nodes (39): AdminOverviewPage(), parseRange(), startOfToday(), Progress(), AdminUsagePage(), parseRange(), TYPE_LABEL, ClearErrorLogsButton() (+31 more)
...
Cohesion: 0.16
Nodes (18): bodySchema, Params, POST(), campaignDeliveryText(), CampaignJobData, processCampaign(), processRecipient(), SEND_INTERVAL_MS (+10 more)

### Community 80 - "scheduler.ts"
Cohesion: 0.14
Nodes (20): appBaseUrl(), createSchema, encryptSensitiveFields(), GET(), POST(), SENSITIVE_FIELDS, assertSafeHttpUrl(), hostnameWithoutBrackets() (+12 more)
...
Cohesion: 0.12
Nodes (18): DELETE(), DELETE(), GET(), POST(), POST(), POST(), POST(), POST() (+10 more)
...
Cohesion: 0.12
Nodes (10): reactAfterInstagramReply(), ResolvedChannel, telegramMarkdownToHtml(), TgMessage, TgUser, InboundMessage, MessengerAdapter, OutboundVoice (+2 more)

### Community 86 - "page.tsx"
Cohesion: 0.09
Nodes (13): AdminConversationsPage(), CHANNEL_LABEL, STATUS_META, GATEWAY_BADGE, PLAN_BADGE, STATUS_BADGE, FilterPills(), TableShell() (+5 more)
...
Cohesion: 0.17
Nodes (16): activateSubscriptionPayment(), ChannelConnectionTarget, ChatGate, monthKey(), persistSubscription(), sendPurchaseConfirmation(), SubscriptionActivation, WorkspaceAccessGate (+8 more)

### Community 89 - "product.ts"
Cohesion: 0.32
Nodes (11): AdminLoginResult, createSessionToken(), decodeBase32(), isValidToken(), safeEqual(), secret(), sign(), totpAt() (+3 more)
...
Cohesion: 0.21
Nodes (10): AdminLoginPage(), metadata, GET(), DELETE(), GET(), execFileAsync, GET(), isAdminAuthed() (+2 more)
...
Cohesion: 0.21
Nodes (12): AdminCommercialEvent, enqueueAdminCommercialSms(), processAdminCommercialSmsPayment(), RETRY_DELAYS_MS, retryAt(), sweepAdminCommercialSmsOutbox(), AiCreditTopupCapture, captureAiCreditTopupPayment() (+4 more)
...
Cohesion: 0.25
Nodes (10): GET(), POST(), GET(), POST(), captureError(), ErrorLevel, metaVerifyToken(), verifyMetaWebhookSignature() (+2 more)
...
Cohesion: 0.18
Nodes (14): detectUnanswered(), evaluateHandoffPolicy(), formatReason(), HandoffDecision, HandoffPolicyInput, HandoffReasonCode, handoffReplyText(), handoffThreshold() (+6 more)
...
Cohesion: 0.17
Nodes (10): DashboardBarList(), NamedPoint, ProductCard, ProductGrid(), ProductsToolbar(), formatDate(), SyncLogEntry, WooIntegrationState (+2 more)

### Community 131 - "page-header.tsx"
Cohesion: 0.13
Nodes (29): AdminVigentoPage(), CAPABILITIES, GET(), PUT(), schema, bodySchema, Params, POST() (+21 more)

### Community 132 - "embeddings.ts"
Cohesion: 0.18
Nodes (17): crawlUrlToKnowledge(), refreshStaleUrlKnowledge(), ChunkOptions, chunkText(), splitBySentence(), contextualChunk(), IngestionJobData, processIngestion() (+9 more)

### Community 133 - "route.ts"
Cohesion: 0.18
Nodes (13): AgentSparkline(), ChannelSettingsCard(), Env, ProductionEnvReport, REQUIRED, requireGroup(), SECRET_MIN_LENGTHS, validateHttpsUrl() (+5 more)
...
Cohesion: 0.15
Nodes (13): doSignOut(), GET(), POST(), POST(), { handlers, auth, signOut }, ADMIN_OWNER_PHONE, isPlatformOwnerPhone(), normalizePhone() (+5 more)
...
Cohesion: 0.21
Nodes (8): MarketingLayout(), SESSION_COOKIE_NAMES, BackToTop(), COPY, Footer(), COPY, Navbar(), SECTION_IDS

### Community 199 - "page.tsx"
Cohesion: 0.17
Nodes (13): AdminPagination(), AdminUsersPage(), BadgeTone, displayPhone(), PLAN_LABEL, PLAN_OPTIONS, PlanFilter, startOfToday() (+5 more)
...
Cohesion: 0.26
Nodes (11): AdminCommercialEventKind, adminCommercialSmsPhone(), captureAdminCommercialSmsError(), compact(), formatAmount(), formatPaidAt(), gatewayLabelFa(), notifyAdminCommercialEvent() (+3 more)

### Community 204 - "route.ts"
Cohesion: 0.24
Nodes (5): metadata, COPY, OnboardingShell(), STEPS, Logo()
...
### Community 216 - "wp-content.ts"
Cohesion: 0.53
Nodes (5): deleteContent(), handleWpContentWebhook(), upsertContent(), WpContentPayload, writeLog()

### Community 217 - "route.ts"
Cohesion: 0.27
Nodes (8): Params, POST(), checkChannelConnectAllowed(), isNonEmptyString(), openPendingWhatsappOAuth(), PendingWhatsappNumber, PendingWhatsappOAuth, mocks

### Community 218 - "route.ts"
Cohesion: 0.20
Nodes (5): assurances, metadata, MobilePlanView, PLAN_TRANSLATION_KEY, PricingSection()

### Community 219 - "page.tsx"
Cohesion: 0.18
Nodes (8): ChatLinkChannel(), COLOR_PRESETS, LinkState, WhatsAppQrConnect(), CHAT_LINK_BACKGROUNDS, ChatLinkSettings, qrcode, qrcode
...
Cohesion: 0.36
Nodes (6): AgentSettingsPage(), BUSINESSES, NewAgentPage(), AgentBuilderEntry(), AgentSettingsData, getEffectivePlanReplyPricesIRR()
...
Cohesion: 0.47
Nodes (5): calculateFinanceSummary(), FinanceInputs, FinanceSummary, parseUsdToIrrRate(), safeNonNegative()

### Community 244 - "customer-identification.ts"
Cohesion: 0.47
Nodes (5): applyExtractedIdentity(), ExtractedIdentity, extractEnglishName(), extractIdentity(), extractPersianName()

## Knowledge Gaps
- **1204 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `mini-services/**`, `node_modules/**`, `metadata` (+1199 more)
...
- **Why does `cn()` connect `route.ts` to `route.ts`, `captureError`, `session.ts`, `page.tsx`, `activity.ts`, `commercial-config.ts`, `ippanel.ts`, `layout.tsx`, `popular-posts.tsx`, `trend-chart.tsx`, `material-select.tsx`, `route.ts`, `page.tsx`, `route.ts`, `social-links.tsx`, `iphone-preview.tsx`, `helpers.ts`, `route.ts`, `chat-orchestrator.ts`, `service-health-panel.tsx`, `instagram.ts`, `PageHeader`, `route.ts`, `conversation-thread.tsx`, `page.tsx`, `route.ts`, `route.ts`, `route.ts`, `route.ts`, `vigento-actions.ts`, `page.tsx`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `getCurrentUser()` connect `prisma.ts` to `cn`, `ui.tsx`, `page-header.tsx`, `campaign-composer.tsx`, `charts.ts`, `page.tsx`, `registry.ts`, `route.ts`, `handler.ts`, `automation-form.tsx`, `woocommerce.ts`, `registry.ts`, `oauth.ts`, `route.ts`, `route.ts`, `jobs.ts`, `getVerticalPack`, `config.ts`, `layout.tsx`, `types.ts`, `route.ts`, `automation-manager.tsx`, `charts.ts`, `booking-manager.tsx`, `automation-manager.tsx`, `scheduler.ts`, `route.ts`, `logo.tsx`, `vigento-actions.ts`, `service.ts`, `route.ts`, `automation-card.tsx`, `tts.ts`, `media-uploader.tsx`, `route.ts`, `vigento-actions.ts`, `formatDateTime`, `normalizeChatLinkSettings`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `getConnectedMessengerChannels()` connect `automation-manager.tsx` to `loader.js`?**
