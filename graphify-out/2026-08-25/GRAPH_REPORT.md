# Graph Report - vignet  (2026-08-25)

## Corpus Check
- 726 files · ~537,364 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4238 nodes · 9927 edges · 276 communities (247 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dab5339f`
...
- store-integrations-section.tsx
...
- listAvailableSlots
- layout.tsx
- capability-options.tsx
- marketing-home-variants.test.ts
- jalaali-js
- recharts
...
1. `cn()` - 202 edges
2. `getCurrentUser()` - 171 edges
3. `requireUser()` - 76 edges
4. `captureError()` - 57 edges
...
Cohesion: 0.11
Nodes (27): AutomationAction, AutomationContext, AutomationPolicy, AutomationRow, AutomationTrigger, commentDmTarget(), DEFAULT_AUTOMATION_POLICY, isReplyMode() (+19 more)
...
### Community 2 - "ui.tsx"
Cohesion: 0.16
Nodes (23): ModelSelect(), TIER_ICON, ReplyCreditEstimator(), getOpenRouterConfigStatus(), AGENT_MODELS, AgentModel, BY_ALIAS, findModel() (+15 more)
...
Cohesion: 0.08
Nodes (29): AgentCatalogPage(), NewAutomationPage(), AgentKnowledgePage(), AgentSettingsPage(), BUSINESSES, NewAgentPage(), BillingPage(), NewInstagramAutomationPage() (+21 more)

### Community 5 - "chat-engine.ts"
Cohesion: 0.19
Nodes (15): Params, POST(), schema, POST(), bareAddress(), InboundEmailEventData, ingestAdminMailboxEmail(), isAdminMailboxRecipient() (+7 more)

### Community 6 - "qr-config.ts"
Cohesion: 0.12
Nodes (22): enqueueAdminCommercialSms(), processAdminCommercialSmsPayment(), RETRY_DELAYS_MS, retryAt(), sweepAdminCommercialSmsOutbox(), AiCreditTopupCapture, captureAiCreditTopupPayment(), activateSubscriptionPayment() (+14 more)
...
Cohesion: 0.05
Nodes (60): AgentWizard(), BUSINESS_PRESETS, channelLabel(), ConfigDraft, CreatedAgent, draftFromRole(), FormState, NaturalConversationControls() (+52 more)
...
Cohesion: 0.08
Nodes (46): appendSalesGuidance(), buildDeterministicTurnReply(), buildSystemPrompt(), bumpProductQueries(), generateReply(), GenerateReplyOptions, GenerateReplyResult, hydrateSystemPrompt() (+38 more)
...
Cohesion: 0.09
Nodes (24): AnalyticsPage(), daysAgo(), nfFa(), STAGE_LABELS_EN, STAGE_LABELS_FA, CHANNEL_LABELS, ChannelIcon, ICON_TONES (+16 more)

### Community 15 - "syncOnboarding"
Cohesion: 0.12
Nodes (20): HomeVariantOneRoute(), metadata, HomeVariantTwoRoute(), metadata, HomeVariantThreeRoute(), metadata, HomeVariantFourRoute(), metadata (+12 more)

### Community 16 - "session.ts"
Cohesion: 0.14
Nodes (22): AdminCreditTopupPatternData, AdminSubscriptionPatternData, formatPersianDate(), generateCode(), IppanelMeta, ippanelSend(), isSmsConfigured(), OtpAuditContext (+14 more)

### Community 17 - "page.tsx"
Cohesion: 0.09
Nodes (30): CHANNEL_LABELS_FA, ConversationsPage(), SalesFilter, VALID_CHANNELS, VALID_SALES_FILTERS, VALID_STATUSES, CampaignComposer(), DraftCampaign (+22 more)

### Community 18 - "activity.ts"
Cohesion: 0.15
Nodes (18): onRequestError(), register(), captureLog(), captureWarning(), emitConsole(), errorDetails(), ErrorLevel, LogLevel (+10 more)
...
Cohesion: 0.10
Nodes (21): asJson(), claimInboundEvent(), ClaimInboundEventInput, ClaimInboundEventResult, InboundEventEffects, InboundEventLease, InboundEventLeaseBusyError, InboundEventLeaseGuard (+13 more)

### Community 22 - "rateLimit"
Cohesion: 0.11
Nodes (20): AdminUsagePage(), parseRange(), TYPE_LABEL, OPTIONS, RangeKind, RangeSwitch(), ActivationFunnel(), AXIS (+12 more)
...
Cohesion: 0.13
Nodes (13): BusyAction, Feedback, fetchOperatorHealth(), GlassButton(), localeDate(), localeNumber(), OperatorChannelHealth, OperatorChannelSetup() (+5 more)
...
Cohesion: 0.08
Nodes (52): batchSchema, digest(), eventSchema, handleManualSync(), loadManualIntegration(), normalizeSiteUrl(), parseDelivery(), pluginVersionFromHeaders() (+44 more)

### Community 28 - "config.ts"
Cohesion: 0.11
Nodes (28): bodySchema, GET(), Params, POST(), GET(), Params, bodySchema, GET() (+20 more)
...
Cohesion: 0.33
Nodes (5): GET(), POST(), metaVerifyToken(), verifyMetaWebhookSignature(), mocks

### Community 35 - "auth.ts"
Cohesion: 0.09
Nodes (12): AutomationForm(), defaultReplyMode(), emptyTextMessage(), KeywordFilter, MediaUploader, MessageBuilder(), normalizeMessage(), PostFilter (+4 more)
...
Cohesion: 0.12
Nodes (29): generateMetadata(), Props, PublicBlogPostPage(), BlogEditor(), isFa(), PublicPost, PublicPostCard(), TrendSpark() (+21 more)
...
Cohesion: 0.08
Nodes (47): POST(), detectUnanswered(), evaluateHandoffPolicy(), formatReason(), HandoffDecision, HandoffPolicyInput, HandoffReasonCode, handoffReplyText() (+39 more)
...
Cohesion: 0.11
Nodes (30): entryOwnerIds(), getContactName(), handleInbound(), handleInstagramGlobalInbound(), IgWebhookEntry, markAssistantDelivery(), persistFixedAssistantReply(), persistInboundOnly() (+22 more)

### Community 42 - "route.ts"
Cohesion: 0.19
Nodes (15): POST(), buildInstagramAuthUrl(), INSTAGRAM_OAUTH_SCOPES, INSTAGRAM_WEBHOOK_FIELDS, instagramAppId(), InstagramProfile, instagramRedirectUri(), LongTokenResponse (+7 more)

### Community 43 - "jobs.ts"
Cohesion: 0.21
Nodes (21): SummaryJobData, createQueueConnection(), isQueueDisabled(), QUEUE_NAMES, dispatchCampaign(), dispatchGlobalInbound(), dispatchInbound(), dispatchIngestion() (+13 more)

### Community 44 - "chat-client.tsx"
Cohesion: 0.06
Nodes (36): bodySchema, GET(), ownAgent(), Params, PUT(), GET(), ownAgent(), Params (+28 more)

### Community 45 - "material-select.tsx"
Cohesion: 0.15
Nodes (24): createHandoffAlert(), captureError(), refreshLongLivedToken(), cleanupOldRecords(), CleanupResult, notifyWorkspace(), mocks, alertSilentChannels() (+16 more)

### Community 46 - "getVerticalPack"
Cohesion: 0.23
Nodes (9): GET(), GET(), DELETE(), GET(), execFileAsync, GET(), isAdminAuthed(), getServerMetrics() (+1 more)

### Community 47 - "vigent-woo.php"
Cohesion: 0.12
Nodes (38): COMMON_COPY, IconName, LocalizedCopy, ProductScenario, VARIANT_COPY, CapabilitySection(), ChannelPills(), ClosingCta() (+30 more)
...
Cohesion: 0.23
Nodes (13): GET(), normalizeSiteUrl(), assertSafeHttpUrl(), hostnameWithoutBrackets(), isBlockedIp(), isBlockedIpv4(), parseHttpUrl(), request() (+5 more)

### Community 50 - "route.ts"
Cohesion: 0.13
Nodes (17): GET(), appBaseUrl(), createSchema, encryptSensitiveFields(), GET(), normalizeWooStoreUrl(), POST(), SENSITIVE_FIELDS (+9 more)

### Community 51 - "page.tsx"
Cohesion: 0.13
Nodes (25): baseUrl(), bodySchema, Params, POST(), WEBHOOK_PATH, baleAdapter(), getBaleBotInfo(), setBaleWebhook() (+17 more)

### Community 52 - "social-links.tsx"
Cohesion: 0.09
Nodes (15): CHANNEL_ICONS, COPY, MobileChannelTab, COPY, Pillar, COPY, Footer(), InstagramIcon() (+7 more)
...
Cohesion: 0.12
Nodes (35): AdminVigentoPage(), CAPABILITIES, GET(), PUT(), schema, POST(), recordRun(), requestSchema (+27 more)

### Community 57 - "vertical-bookings-vigento.test.ts"
Cohesion: 0.16
Nodes (14): metadata, metadata, MarketingLayout(), SESSION_COOKIE_NAMES, Header(), ScopedIntlProvider(), BackToTop(), ADMIN_CLIENT_MESSAGE_PATHS (+6 more)
...
Cohesion: 0.18
Nodes (17): isPlatformOwnerPhone(), ExtractedIdentity, extractEnglishName(), extractIdentity(), extractPersianName(), looksLikePersonName(), NAME_STOPWORDS, buildOrderContext() (+9 more)
...
Cohesion: 0.12
Nodes (18): agent_hint_body(), agent_hint_title(), AgentsPage(), DigitalMenuDashboardPage(), isOrderStatus(), ORDER_STATUSES, OrdersPage(), OrderStatus (+10 more)

### Community 63 - "page.tsx"
Cohesion: 0.12
Nodes (15): ChannelsSection, FaqSection, FeaturesSection, HOME_METADATA_COPY, LivePlatformStats(), PricingSection, SITE_URL, STRUCTURED_DATA_COPY (+7 more)
...
Cohesion: 0.15
Nodes (12): setLocale(), POST(), geistMono, geistSans, ROOT_METADATA_COPY, RootLayout(), Providers(), dirForLocale() (+4 more)
...
Cohesion: 0.11
Nodes (24): bodySchema, Params, POST(), bodySchema, Params, POST(), escapeTelegramHtml(), formatOperatorAlertMessage() (+16 more)
...
Cohesion: 0.25
Nodes (22): checkUserFollows(), executeAction(), tryFulfillFollowGate(), assertPublicHttps(), formatPrice(), messagesUrl(), MetaErrorBody, preflightMedia() (+14 more)
...
Cohesion: 0.14
Nodes (33): AdminOverviewPage(), parseRange(), startOfToday(), ProductsPage(), SystemErrorsPanel(), MobileChannelExplorer(), getAiOverview(), AgentSpark (+25 more)

### Community 75 - "PageHeader"
Cohesion: 0.16
Nodes (16): AutomationCard(), MESSAGE_TYPE_ICON, REPLY_MODE_ICON, TYPE_ICON, FormState, IphonePreviewProps, AutomationMessage, GateMode (+8 more)

### Community 76 - "page.tsx"
Cohesion: 0.20
Nodes (13): POST(), POST(), POST(), { handlers, auth, signOut }, getRequestId(), HeaderSource, requestIdHeaders(), allowOtpVerificationAttempt() (+5 more)

### Community 77 - "conversation-thread.tsx"
Cohesion: 0.18
Nodes (19): ALLOWED, EXTENSION, POST(), GET(), ownAgent(), Params, POST(), buffer (+11 more)
...
Cohesion: 0.16
Nodes (11): DashboardBarList(), NamedPoint, ProductCard, ProductGrid(), ProductsToolbar(), formatDate(), isWooConnected(), SyncLogEntry (+3 more)

### Community 80 - "scheduler.ts"
Cohesion: 0.18
Nodes (10): assurances, metadata, PLAN_FA_NAMES, PRICING_FAQ, PricingPage(), MobilePlanView, PLAN_TRANSLATION_KEY, PricingSection() (+2 more)
...
Cohesion: 0.14
Nodes (18): GET(), PATCH(), AgentLayout(), DashboardLayout(), metadata, OnboardingPage(), SettingsPage(), AgentTabItem (+10 more)

### Community 106 - "service.ts"
Cohesion: 0.08
Nodes (37): AdminAgentDetailPage(), CHANNEL_LABEL, AdminAgentsPage(), AdminBlogPage(), AdminConversationDetailPage(), CHANNEL_LABEL, STATUS_LABEL, AdminConversationsPage() (+29 more)

### Community 107 - "automation-card.tsx"
Cohesion: 0.15
Nodes (19): ChangeDetail, MODULES, VerticalChangeNotice(), BusinessProfileStep(), ICONS, Props, SubStep, DetailsStep() (+11 more)
...
Cohesion: 0.10
Nodes (19): GET(), META, StatusPage(), NotificationBell(), NotificationItem, pushBrowserNotification(), KbItem, KbManager() (+11 more)
...
Cohesion: 0.17
Nodes (23): appHeaders(), asRecord(), chatCompletion(), ChatOptions, ChatTool, ChatToolCall, ChatUsage, DEFAULT_MAX_PRICE (+15 more)
...
Cohesion: 0.23
Nodes (11): bodySchema, GET(), ownAgent(), Params, POST(), DELETE(), Params, checkChannelConnectAllowed() (+3 more)

### Community 121 - "vigento-actions.ts"
Cohesion: 0.20
Nodes (17): DELETE(), Params, settingsSchema, appUrl(), GET(), newWebhookToken(), AutomationPolicySnapshot, buildInstagramOAuthConfig() (+9 more)

### Community 122 - "readBotToken"
Cohesion: 0.23
Nodes (11): DELETE(), GET(), getOwnedAgent(), Params, PATCH(), DELETE(), ownAgent(), Params (+3 more)

### Community 123 - "page.tsx"
Cohesion: 0.14
Nodes (17): ContactDetailPage(), ConversationThreadPage(), ChannelBadge(), ContactAvatar(), SIZES, ContactDeleteAction(), ConversationDeleteAction(), ConversationPanel() (+9 more)

### Community 125 - "normalizeChatLinkSettings"
Cohesion: 0.22
Nodes (15): appBaseUrl(), GET(), appBaseUrl(), createSchema, DELETE(), GET(), maskBotToken(), patchSchema (+7 more)
...
Cohesion: 0.09
Nodes (32): bodySchema, Params, POST(), POST(), confirmSchema, Params, POST(), POST() (+24 more)
...
Cohesion: 0.10
Nodes (16): EASE, ICONS, OnboardingFlow(), Phase, Props, skipSetupStep(), staggerChild, staggerParent (+8 more)
...
Cohesion: 0.42
Nodes (9): allClaimedInstagramIds(), GET(), Params, POST(), PUT(), getScopedWebhookPayloads(), readPageToken(), getIgUserWebhookSubscription() (+1 more)
...
Cohesion: 0.11
Nodes (20): Message, Proposal, QUICK_PROMPTS, VigentoAdminConsole(), WELCOME, Msg, TestPlayground(), VoiceRecorder (+12 more)
...
Cohesion: 0.29
Nodes (15): LocalizedDatePicker(), PickerPosition, WEEKDAYS, asDate(), CalendarMonth, calendarMonthLength(), calendarMonthOffset(), calendarPartsFromDateKey() (+7 more)

### Community 197 - "service-health-panel.tsx"
Cohesion: 0.10
Nodes (20): GET(), PATCH(), Props, bookingErrorResponse(), GET(), POST(), GET(), BookingError (+12 more)

### Community 199 - "page.tsx"
Cohesion: 0.16
Nodes (22): AdminPaymentsPage(), AdminPaymentDetailPage(), StatusSummary(), AdminRevenuePage(), PLAN_BADGE, fmtDay(), fmtIRR(), fmtUSD() (+14 more)
...
Cohesion: 0.38
Nodes (4): pm2_scripts_match_ecosystem(), deploy.sh script, stop_service_and_release_port(), VIGENT_DEPLOYMENT_ID
...
Cohesion: 0.15
Nodes (19): adminLogin(), AdminLoginState, adminLogout(), AdminLoginForm(), initial, AdminLoginPage(), metadata, ADMIN_COOKIE (+11 more)

### Community 216 - "layout.tsx"
Cohesion: 0.18
Nodes (12): GET(), DELETE(), Params, POST(), DELETE(), GET(), isAdminAuthedRequest(), parseHttpUrl() (+4 more)

### Community 217 - "popular-posts.tsx"
Cohesion: 0.22
Nodes (6): hasCompleteCustomerIdentity(), agentCreateSchema, promptConversationSchema, promptFormatSchema, promptQAPairSchema, roleTemplateKeys
...
Cohesion: 0.14
Nodes (20): PATCH(), DELETE(), GET(), ownAgent(), Params, PUT(), putSchema, AgentChannelsPage() (+12 more)
...
Cohesion: 0.05
Nodes (42): NAV_ITEMS, NavItem, NavList(), RangeTabs(), COPY, Meter(), ConversationActions(), Status (+34 more)

### Community 235 - "route.ts"
Cohesion: 0.31
Nodes (7): DELETE(), ownContact(), Params, PATCH(), updateSchema, mocks, params

### Community 236 - "service.ts"
Cohesion: 0.16
Nodes (19): GET(), POST(), BOOKING_AGENT_TOOLS, BOOKING_TOOL_SYSTEM_INSTRUCTION, cancelSchema, executeBookingAgentTool(), slotsSchema, ACTIVE_APPOINTMENT_STATUSES (+11 more)

### Community 238 - "openrouter.ts"
Cohesion: 0.33
Nodes (7): grantIncludedPlanCredit(), planCreditGrantKey(), PlanCreditGrantResult, envInt(), envNonNegativeInt(), getPlanDefs(), PlanDef

### Community 239 - "route.ts"
Cohesion: 0.28
...
Cohesion: 0.10
Nodes (16): FacebookPagesResult, IgHost, IgWebhook, instagramAdapter(), InstagramPageOption, IMPORTANT: do NOT skip messages based on folder flags., ResolvedHost, BotApiError (+8 more)

### Community 243 - "neural-network-primitives.tsx"
Cohesion: 0.09
Nodes (24): Avatar(), ChatLinkClient(), errorText(), Intro(), isRetryableError(), Msg, nextId(), parseAssistant() (+16 more)

### Community 244 - "store-integrations-section.tsx"
Cohesion: 0.23
Nodes (9): formatWooSyncResult(), SyncFeedback, WooSyncResult, entityLabel(), IntegrationCard(), isIntegrationConnected(), StoreIntegrationItem, StoreIntegrationsSection() (+1 more)
...
Cohesion: 0.43
Nodes (5): BrandHeader(), AdminLayout(), metadata, MobileNavTrigger(), requireAdmin()
...
Cohesion: 0.09
Nodes (24): CHANNEL_LABEL, STATUS_META, GATEWAY_BADGE, PLAN_BADGE, STATUS_BADGE, AdminPagination(), TableShell(), Td() (+16 more)

### Community 260 - "auth.config.ts"
Cohesion: 0.29
Nodes (4): authorized(), PROTECTED_PREFIXES, { auth }, config

### Community 262 - "page.tsx"
Cohesion: 0.15
Nodes (13): AdminMailbox(), AdminMailboxItem, senderInitial(), CHANNEL_LABELS, FailedJobLog, HealthPayload, HealthState, QUEUE_LABELS (+5 more)

### Community 263 - "order-context.ts"
Cohesion: 0.39
Nodes (7): campaignDeliveryText(), CampaignJobData, processCampaign(), processRecipient(), SEND_INTERVAL_MS, waitForRateLimit(), runInlineCampaign()

### Community 264 - "intelligence-core-lazy.tsx"
Cohesion: 0.50
Nodes (3): IntelligenceCoreProps, IntelligenceCoreLazy(), LazyIntelligenceCore

### Community 265 - "BusinessTypeValue"
Cohesion: 0.40
Nodes (4): AgentBuilderEntry(), BuildMode, Props, BusinessTypeValue

### Community 266 - "route.ts"
Cohesion: 0.52
Nodes (4): linkNode(), safeLinkHref(), Markdown(), renderInline()

### Community 267 - "listAvailableSlots"
Cohesion: 0.50
...
### Community 269 - "capability-options.tsx"
Cohesion: 0.40
Nodes (5): CapabilityOptions(), Locale, OPTION_META, optionLabel(), BusinessServiceOption

### Community 270 - "marketing-home-variants.test.ts"
Cohesion: 0.60
Nodes (4): read(), root, routeSource(), variantSource()
...
### Community 274 - "emoji.ts"
Cohesion: 0.60
Nodes (3): EMOJI_TOKEN, isEmojiOnly(), ONLY_EMOJI

### Community 275 - "۴. گزارش تست‌ها"
Cohesion: 0.67
Nodes (3): تست‌های جدید اضافه‌شده در ممیزی اولیه (۱۵ مورد), تست‌های جدید موج تکمیلی (۸ مورد), ۴. گزارش تست‌ها

## Knowledge Gaps
- **1288 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `mini-services/**`, `node_modules/**`, `metadata` (+1283 more)
...
- `intelligence-core.tsx` (3× useful, score=1.833554347)
- `ContactsView()` (2× useful, score=1.335146348) _(code changed — re-verify)_
- `sendOutbound()` (2× useful, score=1.335146348) _(code changed — re-verify)_
- `conversationLiveVersion()` (2× useful, score=1.335146348)
- `AgentDetailPage()` (2× useful, score=1.23147162)
- `getConnectionGeometry()` (2× useful, score=1.222714369)
- `neural-operation-graph.tsx` (2× useful, score=1.222044073) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `cn()` connect `react-dom` to `cn`, `ui.tsx`, `conversation-reply-delivery.test.ts`, `prisma.ts`, `page-header.tsx`, `page.tsx`, `layout.tsx`, `capability-options.tsx`, `page.tsx`, `syncOnboarding`, `page.tsx`, `woo-connect-wizard.tsx`, `commercial-config.ts`, `rateLimit`, `automation-form.tsx`, `setup-whatsapp-bridge.sh`, `layout.tsx`, `oauth.ts`, `vigent-woo.php`, `route.ts`, `social-links.tsx`, `iphone-preview.tsx`, `helpers.ts`, `page.tsx`, `global-error.tsx`, `ingest.ts`, `page.tsx`, `page.tsx`, `route.ts`, `automation-manager.tsx`, `scheduler.ts`, `page.tsx`, `logo.tsx`, `material-select.tsx`, `service.ts`, `automation-card.tsx`, `page.tsx`, `neural-network-primitives.tsx`, `store-integrations-section.tsx`, `page.tsx`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `getCurrentUser()` connect `chat-client.tsx` to `route.ts`, `prisma.ts`, `route.ts`, `campaign-composer.tsx`, `listAvailableSlots`, `models.ts`, `woocommerce.ts`, `vigento-actions.ts`, `route.ts`, `route.ts`, `layout.tsx`, `page.tsx`, `route.ts`, `low-credit-alert.ts`, `chat-orchestrator.ts`, `service-health-panel.tsx`, `route.ts`, `conversation-thread.tsx`, `API`, `validation.ts`, `wp-content.ts`, `material-select.tsx`, `route.ts`, `service.ts`, `media-uploader.tsx`, `route.ts`, `route.ts`, `route.ts`, `vigento-actions.ts`, `readBotToken`, `rag.ts`, `normalizeChatLinkSettings`, `admin-broadcast-form.tsx`, `route.ts`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `@prisma/client`, `jalaali-js`, `recharts`, `isAdminAuthed`, `index.ts`?**
