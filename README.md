...
در هر جلسه، پیام‌های کوتاه بدون خلاصه‌سازی حفظ می‌شوند. وقتی تاریخچهٔ خام از حدود ۲۴۰۰ توکن تخمینی عبور کند، پیام‌های قدیمی به خلاصه‌ای فشرده از اطلاعات مشتری، هدف، تصمیم‌ها و قدم بعدی تبدیل می‌شوند؛ حدود ۱۲۰۰ توکن از پیام‌های اخیر کامل می‌ماند. تخمین بر اساس حجم UTF-8 است و شمارش دقیق مدل نیست. سقف محافظتی ۶۴ پیام از بارگیری نامحدود جلوگیری می‌کند؛ جدیدترین پیام حتی اگر طولانی باشد کامل حفظ می‌شود. خلاصه با مدل اقتصادی ساخته و مصرف آن با نوع `SUMMARY` ثبت می‌شود. ارسال خلاصه همراه هر پاسخ نیز توکن ورودی مصرف می‌کند.
