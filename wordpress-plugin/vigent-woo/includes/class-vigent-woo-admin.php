...
class Vigent_Woo_Admin {
                        ...
                        <div class="vg-grid has-aside">
                                ...
                                <aside>
                                        <div class="vg-card">
                                                ...
                                                <ol class="vg-steps">
                                                        <li><strong><?php esc_html_e( 'در پنل ویجنت:', 'vigent-woo' ); ?></strong> <?php esc_html_e( 'یک اتصال سایت (وردپرس/ووکامرس) بسازید.', 'vigent-woo' ); ?></li>
        ...
        public function render_help_page() {
                ...
                <div class="wrap vg-wrap">
                        ...
                        <div class="vg-card">
                                ...
                                <ol class="vg-steps">
                                        <li><strong><?php esc_html_e( 'ساخت اتصال در پنل ویجنت:', 'vigent-woo' ); ?></strong><br><?php esc_html_e( 'به پنل ویجنت بروید و یک اتصال سایت (وردپرس/ووکامرس) بسازید. ویجنت به‌صورت خودکار لینک و کلید تولید می‌کند.', 'vigent-woo' ); ?></li>
        ...
        private function render_status_badge( $status ) {
                // If plugin is not configured (no webhook URL/secret), show "پیکربندی نشده".
                if ( ! $this->core()->is_configured() ) {
                        echo '<span class="vg-status warn"><span class="dot"></span> ' . esc_html__( 'پیکربندی نشده', 'vigent-woo' ) . '</span>';
                        return;
                }
                ...
                if ( true === $connected ) {
                        ...
                        // Configured but no ping sent yet — show "در انتظار" not "نامشخص".
                        echo '<span class="vg-status warn"><span class="dot"></span> ' . esc_html__( 'در انتظار بررسی', 'vigent-woo' ) . '</span>';
                }
        }

        private function render_live_status( $status ) {
                // If plugin is not configured, show a "needs setup" banner.
                if ( ! $this->core()->is_configured() ) {
                        printf(
                                '<div id="vg-live-status" class="vg-live-status unknown"><span class="icon dashicons dashicons-warning"></span><div class="text"><strong>%s</strong><small>%s</small></div></div>',
                                esc_html__( 'پیکربندی نشده', 'vigent-woo' ),
                                esc_html__( 'برای شروع، آدرس webhook و کلید امنیتی را در تب تنظیمات اتصال وارد کنید.', 'vigent-woo' )
                        );
                        return;
                }
                $connected = $status['connected'];
                ...
                $msg = true === $connected ? __( 'اتصال برقرار است', 'vigent-woo' ) : ( false === $connected ? __( 'اتصال قطع است', 'vigent-woo' ) : __( 'در انتظار بررسی', 'vigent-woo' ) );
                $sub = $status['last_check'] ? sprintf( __( 'آخرین بررسی: %s', 'vigent-woo' ), $status['last_check'] ) : __( 'هنوز بررسی نشده — دکمهٔ «تست اتصال» را بزنید', 'vigent-woo' );
